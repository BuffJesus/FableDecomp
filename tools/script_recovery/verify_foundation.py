...
def verify(root: Path) -> dict[str, Any]:
    ...
    check("evidence-complete native helpers execute as standalone Lua",
          helper_lua_manifest["summary"] == {"emitted": 16, "deploymentEligible": 0} and
          ...
          helper_lua_validation["summary"] == {
              "helpers": 16, "passed": 16, "checks": 111, "complete": True},
    ...
    check("generated helpers reduce the native conversion backlog",
          readiness_summary["resolvedNativeHelperMethods"] == 16 and
          readiness_summary["resolvedNativeHelperCalls"] == 188 and
          readiness_summary["scriptsWithResolvedNativeHelpers"] == 124 and
          readiness_summary["unresolvedNativeHelperMethods"] == 137 and
          readiness_summary["unresolvedNativeHelperCalls"] == 1389 and
