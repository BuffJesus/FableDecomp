...
def verify(root: Path) -> dict[str, Any]:
    ...
    check("evidence-complete native helpers execute as standalone Lua",
          helper_lua_manifest["summary"] == {"emitted": 25, "deploymentEligible": 0} and
          {row["targetAddress"] for row in helper_lua_entries} == {
              ...
              "0x006E7B80", "0x007E74D0", "0x0099A2D0", "0x0099A2E0",
              "0x00CBED82", "0x00CD2770",
          ...
          helper_lua_validation["summary"] == {
              "helpers": 25, "passed": 25, "checks": 129, "complete": True},
    ...
    check("generated helpers reduce the native conversion backlog",
          readiness_summary["resolvedNativeHelperMethods"] == 23 and
          readiness_summary["resolvedNativeHelperCalls"] == 545 and
          readiness_summary["scriptsWithResolvedNativeHelpers"] == 138 and
          readiness_summary["unresolvedNativeHelperMethods"] == 130 and
          readiness_summary["unresolvedNativeHelperCalls"] == 1032 and
