...
def verify(root: Path) -> dict[str, Any]:
    ...
    check("evidence-complete native helpers execute as standalone Lua",
          helper_lua_manifest["summary"] == {"emitted": 26, "deploymentEligible": 0} and
          ...
          helper_lua_validation["summary"] == {
              "helpers": 26, "passed": 26, "checks": 132, "complete": True},
    ...
    check("generated helpers reduce the native conversion backlog",
          readiness_summary["resolvedNativeHelperMethods"] == 24 and
          readiness_summary["resolvedNativeHelperCalls"] == 825 and
          readiness_summary["scriptsWithResolvedNativeHelpers"] == 140 and
          readiness_summary["unresolvedNativeHelperMethods"] == 129 and
          readiness_summary["unresolvedNativeHelperCalls"] == 752 and
