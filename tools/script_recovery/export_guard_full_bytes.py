#!/usr/bin/env python3
"""Reproduce complete retail NOVI_Guard Init/Main byte snapshots."""
from __future__ import annotations
import argparse,hashlib,json
from pathlib import Path
import pefile
from capstone import CS_ARCH_X86,CS_MODE_32,Cs
REGIONS=(("Init",0x00DAC650,0x00DAC760),("Main",0x00DAC760,0x00DADE4B))
def export(exe:Path)->dict:
 ...
 return {'schema':'guard-full-retail-bytes/0.1','source':'installed retail Fable.exe PE image','sourceSha256':hashlib.sha256(raw).hexdigest().upper(),'nativeClass':'CNOVI_Guard','regions':rows,
 'coverage':{'operations':'Init and complete Main dispatcher','claimRange':'0x00DAC7A3-0x00DACA21','lectureRange':'0x00DACB33-0x00DAD867','sharedCounters':['BadDeedsPerformed','GuardsDealtWithBadDeeds'],'terminalCleanup':'0x00DADE16-0x00DADE4A'}}
def main()->int:
