...
| Verified functional or matching reconstruction | **6,887 · 13.89%** |
| Byte-identical reconstruction | **3,456 · 6.97%** |
...
Current functional-or-matching coverage is **13.89%** of the 49,568-function catalog.
Of that verified set, **6.97%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **7,040** |
| Reconstruction | Verified functional or matching C++ | **6,887** (13.89%) |
| Reconstruction | — of which byte-**identical** C++ | 3,456 (6.97%) |
...
| Auto-RE intake | Generated candidates / structural checker PASS | 894 / 881 |
...
Counts above are from the 2026-08-07 canonical refresh:
...
because a structural checker accepted it. The 13.89% figure is intentionally the strict,
