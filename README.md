...
| Verified functional or matching reconstruction | **5,355 · 10.80%** |
| Byte-identical reconstruction | **3,013 · 6.08%** |
...
Current functional-or-matching coverage is **10.80%** of the 49,568-function catalog.
Of that verified set, **6.08%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,506** |
| Reconstruction | Verified functional or matching C++ | **5,355** (10.80%) |
| Reconstruction | — of which byte-**identical** C++ | 3,013 (6.08%) |
...
because a structural checker accepted it. The 10.80% figure is intentionally the strict,
