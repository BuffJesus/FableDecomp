...
| Verified functional or matching reconstruction | **5,285 · 10.66%** |
| Byte-identical reconstruction | **2,965 · 5.98%** |
...
Current functional-or-matching coverage is **10.66%** of the 49,568-function catalog.
Of that verified set, **5.98%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,436** |
| Reconstruction | Verified functional or matching C++ | **5,285** (10.66%) |
| Reconstruction | — of which byte-**identical** C++ | 2,965 (5.98%) |
...
because a structural checker accepted it. The 10.66% figure is intentionally the strict,
