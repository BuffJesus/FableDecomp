...
| Verified functional or matching reconstruction | **7,457 · 15.04%** |
| Byte-identical reconstruction | **3,645 · 7.35%** |
...
Current functional-or-matching coverage is **15.04%** of the 49,568-function catalog.
Of that verified set, **7.35%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **7,611** |
| Reconstruction | Verified functional or matching C++ | **7,457** (15.04%) |
| Reconstruction | — of which byte-**identical** C++ | 3,645 (7.35%) |
| Reconstruction | Compiled sources still honestly `DIFFER` | 44 |
| Reconstruction | Compiled rows lacking a Ghidra function-start oracle | 128 |
| Auto-RE intake | Generated candidates / structural checker PASS | 894 / 882 |
...
Counts above are from the 2026-08-10 canonical refresh:
...
because a structural checker accepted it. The 15.04% figure is intentionally the strict,
