...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **4,907** |
| Reconstruction | Retail `.text` match (exact + relocation-normalized) | **4,580** (9.24%) |
| Reconstruction | — of which byte-**identical** (no relocation masking) | 2,683 (5.41%) |
