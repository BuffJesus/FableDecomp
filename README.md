...
| Verified functional or matching reconstruction | **18,596 · 37.52%** |
...
Current functional-or-matching coverage is **37.52%** of the 49,568-function catalog.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **18,674** |
| Reconstruction | Verified functional or matching C++ | **18,596** (37.52%) |
...
because a structural checker accepted it. The 37.52% figure is intentionally the strict,
