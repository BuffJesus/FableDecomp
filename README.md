...
| Verified functional or matching reconstruction | **18,843 · 38.01%** |
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **18,869** |
| Reconstruction | Verified functional or matching C++ | **18,843** (38.01%) |
...
| Readability | Landed sources typed onto shared PDB-named engine headers | 688 |
