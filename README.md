...
| Verified functional or matching reconstruction | **5,335 · 10.76%** |
| Byte-identical reconstruction | **2,998 · 6.05%** |
...
Current functional-or-matching coverage is **10.76%** of the 49,568-function catalog.
Of that verified set, **6.05%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,486** |
| Reconstruction | Verified functional or matching C++ | **5,335** (10.76%) |
| Reconstruction | — of which byte-**identical** C++ | 2,998 (6.05%) |
...
because a structural checker accepted it. The 10.76% figure is intentionally the strict,
