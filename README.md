...
| Verified functional or matching reconstruction | **7,451 · 15.03%** |
...
Current functional-or-matching coverage is **15.03%** of the 49,568-function catalog.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **7,605** |
| Reconstruction | Verified functional or matching C++ | **7,451** (15.03%) |
...
because a structural checker accepted it. The 15.03% figure is intentionally the strict,
