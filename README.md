...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **4,116** |
| Reconstruction | Retail `.text` match (exact + relocation-normalized) | **3,789** (7.65%) |
| Reconstruction | — of which byte-**identical** (no relocation masking) | 1,921 (3.88%) |
...
parity is **7.65%** of the 49,553-function catalog. The lower match count than an earlier README is an
...
The 7.65% figure is intentionally the strict, whole-executable denominator. The boot-path rows are
