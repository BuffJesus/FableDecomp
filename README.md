...
| Reconstruction | VC7.1-compiled **and** behaviour-tested | **118+** (rebuild pending) |
| Reconstruction | Verified functional-or-matching C++ | 77+ (0.155%) |
| Reconstruction | Byte-identical retail `.text` match | 55+ (0.111%, climbing) |
