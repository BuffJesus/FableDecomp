...
| Verified functional or matching reconstruction | **18,609 · 37.54%** |
...
Current functional-or-matching coverage is **37.54%** of the 49,568-function catalog.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **18,687** |
| Reconstruction | Verified functional or matching C++ | **18,609** (37.54%) |
...
because a structural checker accepted it. The 37.54% figure is intentionally the strict,
