...
| Verified functional or matching reconstruction | **7,187 · 14.50%** |
| Byte-identical reconstruction | **3,594 · 7.25%** |
...
Current functional-or-matching coverage is **14.50%** of the 49,568-function catalog.
Of that verified set, **7.25%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **7,340** |
| Reconstruction | Verified functional or matching C++ | **7,187** (14.50%) |
| Reconstruction | — of which byte-**identical** C++ | 3,594 (7.25%) |
...
Counts above are from the 2026-08-09 canonical refresh:
...
because a structural checker accepted it. The 14.50% figure is intentionally the strict,
