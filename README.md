...
| Verified functional or matching reconstruction | **5,276 · 10.64%** |
| Byte-identical reconstruction | **2,960 · 5.97%** |
...
Current functional-or-matching coverage is **10.64%** of the 49,568-function catalog.
Of that verified set, **5.97%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,427** |
| Reconstruction | Verified functional or matching C++ | **5,276** (10.64%) |
| Reconstruction | — of which byte-**identical** C++ | 2,960 (5.97%) |
...
because a structural checker accepted it. The 10.64% figure is intentionally the strict,
