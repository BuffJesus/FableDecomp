...
| Verified functional or matching reconstruction | **5,372 · 10.84%** |
| Byte-identical reconstruction | **3,029 · 6.11%** |
...
Current functional-or-matching coverage is **10.84%** of the 49,568-function catalog.
Of that verified set, **6.11%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,523** |
| Reconstruction | Verified functional or matching C++ | **5,372** (10.84%) |
| Reconstruction | — of which byte-**identical** C++ | 3,029 (6.11%) |
...
because a structural checker accepted it. The 10.84% figure is intentionally the strict,
