...
| Reconstruction | VC7.1-compiled **and** behaviour-tested | **94** (0.190%) |
| Reconstruction | Verified functional-or-matching C++ | 71 (0.143%) |
| Reconstruction | Byte-identical retail `.text` match | 51 (0.103%) |
