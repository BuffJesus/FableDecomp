...
| Verified functional or matching reconstruction | **5,258 · 10.61%** |
| Byte-identical reconstruction | **2,946 · 5.94%** |
...
Current functional-or-matching coverage is **10.61%** of the 49,568-function catalog.
Of that verified set, **5.94%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,409** |
| Reconstruction | Verified functional or matching C++ | **5,258** (10.61%) |
| Reconstruction | — of which byte-**identical** C++ | 2,946 (5.94%) |
...
because a structural checker accepted it. The 10.61% figure is intentionally the strict,
