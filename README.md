...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **4,908** |
| Reconstruction | Retail `.text` match (exact + relocation-normalized) | **4,581** (9.24%) |
| Reconstruction | — of which byte-**identical** (no relocation masking) | 2,684 (5.42%) |
...
parity is **9.24%** of the 49,552-function catalog. The lower match count than an earlier README is an
...
The 9.24% figure is intentionally the strict, whole-executable denominator. The boot-path rows are
