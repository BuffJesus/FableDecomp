...
| Verified functional or matching reconstruction | **18,583 · 37.49%** |
...
Current functional-or-matching coverage is **37.49%** of the 49,568-function catalog.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **18,661** |
| Reconstruction | Verified functional or matching C++ | **18,583** (37.49%) |
...
because a structural checker accepted it. The 37.49% figure is intentionally the strict,
