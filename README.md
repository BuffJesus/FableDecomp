...
parity is **9.22%** of the 49,552-function catalog. The lower match count than an earlier README is an
...
The 9.22% figure is intentionally the strict, whole-executable denominator. The boot-path rows are
