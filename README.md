...
| Verified functional or matching reconstruction | **5,389 · 10.87%** |
| Byte-identical reconstruction | **3,044 · 6.14%** |
...
Current functional-or-matching coverage is **10.87%** of the 49,568-function catalog.
Of that verified set, **6.14%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,540** |
| Reconstruction | Verified functional or matching C++ | **5,389** (10.87%) |
| Reconstruction | — of which byte-**identical** C++ | 3,044 (6.14%) |
...
because a structural checker accepted it. The 10.87% figure is intentionally the strict,
