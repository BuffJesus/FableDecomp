...
| Verified functional or matching reconstruction | **18,758 · 37.84%** |
| Byte-identical reconstruction | **8,111 · 16.36%** |
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **18,836** |
| Reconstruction | Verified functional or matching C++ | **18,758** (37.84%) |
| Reconstruction | — of which byte-**identical** C++ | 8,111 (16.36%) |
