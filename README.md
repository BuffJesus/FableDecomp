...
| Verified functional or matching reconstruction | **18,827 · 37.98%** |
| Byte-identical reconstruction | **8,153 · 16.45%** |
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **18,853** |
| Reconstruction | Verified functional or matching C++ | **18,827** (37.98%) |
| Reconstruction | — of which byte-**identical** C++ | 8,153 (16.45%) |
| Reconstruction | — of which hand-written asm bakes (grade `asm_bake`, **not** counted as reconstruction) | 292 |
| Readability | Landed sources typed onto shared PDB-named engine headers | 679 |
