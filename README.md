...
| Verified functional or matching reconstruction | **5,380 · 10.85%** |
| Byte-identical reconstruction | **3,036 · 6.12%** |
...
Current functional-or-matching coverage is **10.85%** of the 49,568-function catalog.
Of that verified set, **6.12%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,531** |
| Reconstruction | Verified functional or matching C++ | **5,380** (10.85%) |
| Reconstruction | — of which byte-**identical** C++ | 3,036 (6.12%) |
...
because a structural checker accepted it. The 10.85% figure is intentionally the strict,
