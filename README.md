...
| Verified functional or matching reconstruction | **5,293 · 10.68%** |
| Byte-identical reconstruction | **2,967 · 5.99%** |
...
Current functional-or-matching coverage is **10.68%** of the 49,568-function catalog.
Of that verified set, **5.99%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,444** |
| Reconstruction | Verified functional or matching C++ | **5,293** (10.68%) |
| Reconstruction | — of which byte-**identical** C++ | 2,967 (5.99%) |
...
because a structural checker accepted it. The 10.68% figure is intentionally the strict,
