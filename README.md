...
| Verified functional or matching reconstruction | **18,677 · 37.68%** |
...
Current functional-or-matching coverage is **37.68%** of the 49,568-function catalog.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **18,755** |
| Reconstruction | Verified functional or matching C++ | **18,677** (37.68%) |
...
because a structural checker accepted it. The 37.68% figure is intentionally the strict,
