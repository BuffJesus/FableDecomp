...
| Verified functional or matching reconstruction | **18,767 · 37.86%** |
| Byte-identical reconstruction | **8,118 · 16.38%** |
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **18,845** |
| Reconstruction | Verified functional or matching C++ | **18,767** (37.86%) |
| Reconstruction | — of which byte-**identical** C++ | 8,118 (16.38%) |
