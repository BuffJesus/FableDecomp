...
| Verified functional or matching reconstruction | **5,347 · 10.79%** |
| Byte-identical reconstruction | **3,007 · 6.07%** |
...
Current functional-or-matching coverage is **10.79%** of the 49,568-function catalog.
Of that verified set, **6.07%** is byte-identical C++.
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **5,498** |
| Reconstruction | Verified functional or matching C++ | **5,347** (10.79%) |
| Reconstruction | — of which byte-**identical** C++ | 3,007 (6.07%) |
...
because a structural checker accepted it. The 10.79% figure is intentionally the strict,
