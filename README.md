...
| Verified functional or matching reconstruction | **18,830 · 37.99%** |
| Byte-identical reconstruction | **8,155 · 16.45%** |
...
| Reconstruction | Curated sources, VC7.1-compiled **and** behaviour-gated | **18,856** |
| Reconstruction | Verified functional or matching C++ | **18,830** (37.99%) |
| Reconstruction | — of which byte-**identical** C++ | 8,155 (16.45%) |
