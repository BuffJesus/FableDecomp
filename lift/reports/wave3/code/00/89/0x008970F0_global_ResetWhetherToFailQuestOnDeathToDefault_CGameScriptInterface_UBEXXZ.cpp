...
{
public:
    void __thiscall ResetWhetherToFailQuestOnDeathToDefault() const;
};
...
struct CGameScriptInterface_ResetWhetherToFailQuestOnDeathToDefault_SelfOverlay
{
...
static_assert(
    offsetof(
        CGameScriptInterface_ResetWhetherToFailQuestOnDeathToDefault_SelfOverlay,
        m_Field14) == 0x14);
...
using Call0057A5BDFn = void (__thiscall*)(void*);
...
auto* const Call0057A5BD =
    reinterpret_cast<Call0057A5BDFn>(0x0057A5BD);
}

void __thiscall CGameScriptInterface::ResetWhetherToFailQuestOnDeathToDefault() const
{
    const auto* const self =
        reinterpret_cast<
            const CGameScriptInterface_ResetWhetherToFailQuestOnDeathToDefault_SelfOverlay*>(this);
