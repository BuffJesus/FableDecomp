...
{
bool __fastcall IsAbleToMove(CThing* pThing);
}
...
{
public:
    bool __thiscall IsEntityAbleToAttack(const CScriptThing& entity) const
    {
        ...
        if ((pThing != nullptr) &&
            ((reinterpret_cast<const CThingOverlay*>(pThing)->m_Flags91 & 0x01) == 0))
        {
            return NCreatureMode::IsAbleToMove(pThing);
        }
