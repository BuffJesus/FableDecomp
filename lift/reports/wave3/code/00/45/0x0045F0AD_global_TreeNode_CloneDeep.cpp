...
TreeNodeOverlay* __stdcall TreeNode_CloneDeep(TreeNodeOverlay* source, TreeNodeOverlay* link)
{
    TreeNodeOverlay* rootClone = TreeNode_AllocData(source->data10);
    ...
    {
        TreeNodeOverlay* siblingClone = TreeNode_AllocData(sibling->data10);
