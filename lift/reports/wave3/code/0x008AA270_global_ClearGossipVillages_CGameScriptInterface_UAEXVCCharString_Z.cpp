...
{
public:
    virtual void __thiscall ClearGossipVillages(CCharString gossipVillage);
};

void __thiscall CGameScriptInterface::ClearGossipVillages(CCharString gossipVillage)
{
    CCharString localKey(gossipVillage);
    CArray<CMeshDataBank::CLipSyncEntry>& entries = DAT_013bae50[localKey];
