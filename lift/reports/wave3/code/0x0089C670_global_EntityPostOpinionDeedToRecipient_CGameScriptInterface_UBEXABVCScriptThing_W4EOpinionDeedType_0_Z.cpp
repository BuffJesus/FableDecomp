...
{
public:
    void __thiscall EntityPostOpinionDeedToRecipient(
...
void __thiscall CGameScriptInterface::EntityPostOpinionDeedToRecipient(
    const CScriptThing& entity,
    EOpinionDeedType deedType,
    const CScriptThing& recipient) const
{
    ...
    if ((pEntityThing != nullptr) && (pRecipientThing != nullptr))
    {
            ...
            ((pEntityThingOverlay->m_Flags28 & 0x00020000U) != 0))
        {
            ...
            pDeedLog->PostDeed(
                ...
                static_cast<EOpinionPostDeedType>(1),
                bParam6,
                false,
                nullptr,
                false,
