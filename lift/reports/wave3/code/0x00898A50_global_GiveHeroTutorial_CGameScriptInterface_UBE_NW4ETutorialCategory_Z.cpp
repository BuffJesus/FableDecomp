...
{
public:
    bool __thiscall GiveHeroTutorial(ETutorialCategory category) const;
};
...
struct CGameScriptInterface_GiveHeroTutorial_SelfOverlay
{
...
static_assert(
    offsetof(CGameScriptInterface_GiveHeroTutorial_SelfOverlay, m_Field14) == 0x14);

struct CGameScriptInterface_GiveHeroTutorial_TargetOverlay
{
...
static_assert(
    offsetof(CGameScriptInterface_GiveHeroTutorial_TargetOverlay, m_Flags24) == 0x24);
static_assert(
    offsetof(CGameScriptInterface_GiveHeroTutorial_TargetOverlay, m_TCInterfaceMap) == 0x44);
static_assert(
    offsetof(CGameScriptInterface_GiveHeroTutorial_TargetOverlay, m_Flags91) == 0x91);

using Fn_00449970 = void* (__thiscall*)(void*);
using Fn_00487DC0 =
    CGameScriptInterface_GiveHeroTutorial_TargetOverlay* (__thiscall*)(void*);
...
bool __thiscall CGameScriptInterface::GiveHeroTutorial(
    ETutorialCategory category) const
{
    const auto* const self =
        reinterpret_cast<const CGameScriptInterface_GiveHeroTutorial_SelfOverlay*>(this);
