...
//=== UnpackNames @ 00a2ed10 ===

/* [bsim sim=0.5937708986625455 <- ego_r]
   private: void __thiscall C3DMeshStats::UnpackNames(class std::vector<class CCharString,class
   std::allocator<class CCharString> > &,bool,class CCharString const &,bool)const  */

void __thiscall
C3DMeshStats::UnpackNames
          (C3DMeshStats *this,vector<CCharString,std::allocator<CCharString>_> *param_1,bool param_2
          ,CCharString *param_3,bool param_4)

{
  CCharString *this_00;
  ushort uVar1;
  vector<CCharString,std::allocator<CCharString>_> *pvVar2;
  ushort *puVar3;
  char *_Str2;
  int iVar4;
  ulong uVar5;
  pair<unsigned_long,C3DDummyObject> *ppVar6;
  pair<unsigned_long,C3DDummyObject> *ppVar7;
  ...
  size_t local_10;
  ulong local_c;
  C3DMeshStats *local_8;
  int local_4;
  
  pvVar2 = param_1;
  puVar3 = *(ushort **)(this + 0x74);
  if (puVar3 != (ushort *)0x0) {
    _Str1 = puVar3 + 1;
    if (param_2) {
      _Str1 = (ushort *)((int)puVar3 + (uint)*puVar3);
    }
    if (*(int *)param_3 == 0) {
      local_10 = 0;
    }
    else {
      local_10 = *(size_t *)(*(int *)param_3 + 4);
    }
    puVar3 = _Str1;
    do {
      uVar1 = *puVar3;
    ...
    local_4 = (int)puVar3 - (int)((int)_Str1 + 1);
    local_8 = this;
    while (local_4 != 0) {
      if (local_10 == 0) {
LAB_00a2edaa:
        CCharString::CCharString((CCharString *)&param_1,(char *)_Str1,-1);
        iVar4 = 1;
        ppVar9 = extraout_EDX;
        if (param_4 == false) {
          if (param_2 == false) {
            if (param_1 == (vector<CCharString,std::allocator<CCharString>_> *)0x0) {
              uVar5 = 0;
              puVar8 = &DAT_0129aaf4;
            }
            else {
            ...
            local_c = CCRC::Calc(0,puVar8,uVar5);
            ppVar6 = CPreAllocVectorMap<unsigned_long,C3DDummyObject,CKeyPairCompareLess<unsigned_long,C3DDummyObject>_>
                     ::UpperBound((CPreAllocVectorMap<unsigned_long,C3DDummyObject,CKeyPairCompareLess<unsigned_long,C3DDummyObject>_>
                                   *)(this + 0x38),&local_c);
            ppVar7 = CPreAllocVectorMap<unsigned_long,C3DDummyObject,CKeyPairCompareLess<unsigned_long,C3DDummyObject>_>
                     ::LowerBound((CPreAllocVectorMap<unsigned_long,C3DDummyObject,CKeyPairCompareLess<unsigned_long,C3DDummyObject>_>
                                   *)(this + 0x38),&local_c);
            ppVar9 = (pair<EHeroMorphType,CParticleMorphs::CEntry> *)
                     (((int)ppVar6 - (int)ppVar7) / 0x14 + ((int)ppVar6 - (int)ppVar7 >> 0x1f));
          }
          else {
            if (param_1 == (vector<CCharString,std::allocator<CCharString>_> *)0x0) {
              uVar5 = 0;
            ...
            ppVar7 = CPreAllocVectorMap<unsigned_long,C3DDummyObject,CKeyPairCompareLess<unsigned_long,C3DDummyObject>_>
                     ::LowerBound((CPreAllocVectorMap<unsigned_long,C3DDummyObject,CKeyPairCompareLess<unsigned_long,C3DDummyObject>_>
                                   *)(this + 0x48),&local_c);
            ppVar9 = (pair<EHeroMorphType,CParticleMorphs::CEntry> *)
                     (((int)ppVar6 - (int)ppVar7) / 0x38 + ((int)ppVar6 - (int)ppVar7 >> 0x1f));
          }
          iVar4 = (int)ppVar9 - ((int)ppVar9 >> 0x1f);
          this = local_8;
          if (0 < iVar4) goto LAB_00a2ee76;
        }
        else {
LAB_00a2ee76:
          do {
            this_00 = *(CCharString **)(pvVar2 + 4);
            if (this_00 == *(CCharString **)(pvVar2 + 8)) {
              FUN_00433530(this_00,&param_1,&param_2,1,1);
              ppVar9 = extraout_EDX_01;
            }
            else {
              if (this_00 != (CCharString *)0x0) {
                CCharString::CCharString(this_00,(CCharString *)&param_1);
                ppVar9 = extraout_EDX_00;
              }
              *(int *)(pvVar2 + 4) = *(int *)(pvVar2 + 4) + 4;
            }
            iVar4 = iVar4 + -1;
          } while (iVar4 != 0);
        }
        ...
        _Cons_val<std::allocator<std::pair<EHeroMorphType,CParticleMorphs::CEntry>_>,std::pair<EHeroMorphType,CParticleMorphs::CEntry>,std::pair<enum_EHeroMorphType,class_CParticleMorphs::CEntry>_const&>
                  ((allocator<std::pair<EHeroMorphType,CParticleMorphs::CEntry>_> *)&param_1,ppVar9,
                   unaff_EBX);
      }
      else {
        if (*(undefined4 **)param_3 == (undefined4 *)0x0) {
          ...
          _Str2 = (char *)**(undefined4 **)param_3;
        }
        iVar4 = strncmp((char *)_Str1,_Str2,local_10);
        if (iVar4 == 0) goto LAB_00a2edaa;
      }
      _Str1 = (ushort *)(local_4 + 1 + (int)_Str1);
      puVar3 = _Str1;
      do {
        uVar1 = *puVar3;
        puVar3 = (ushort *)((int)puVar3 + 1);
