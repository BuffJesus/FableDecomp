...
struct SummonerLightningDispatchTarget_Overlay
{
...
static_assert(offsetof(SummonerLightningDispatchTarget_Overlay, vftable10) == 0x10);
}

void __fastcall CSBAgents_BuildAndDispatch_SummonerLightning(
    CSteeringAgent* agent,
    SteeringAgentVector* agents)
{
    ...
    auto* const dispatchTarget =
        reinterpret_cast<SummonerLightningDispatchTarget_Overlay*>(ctorResult.edxAfterCall);
