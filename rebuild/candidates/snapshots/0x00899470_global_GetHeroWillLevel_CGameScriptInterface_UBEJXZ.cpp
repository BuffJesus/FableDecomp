...
{
public:
    virtual long __thiscall GetHeroWillLevel() const;
};
...
struct CGameScriptInterface_GetHeroWillLevel_SelfOverlay
{
...
static_assert(
    offsetof(
        CGameScriptInterface_GetHeroWillLevel_SelfOverlay,
        m_Field14) == 0x14);

struct CGameScriptInterface_GetHeroWillLevel_TCInterfaceEntryOverlay
{
...
static_assert(
    offsetof(
        CGameScriptInterface_GetHeroWillLevel_TCInterfaceEntryOverlay,
        m_Key) == 0x00);
static_assert(
    offsetof(
        CGameScriptInterface_GetHeroWillLevel_TCInterfaceEntryOverlay,
        m_pInterface) == 0x04);
static_assert(
    sizeof(CGameScriptInterface_GetHeroWillLevel_TCInterfaceEntryOverlay) == 0x08);

struct CGameScriptInterface_GetHeroWillLevel_TargetOverlay
{
...
static_assert(
    offsetof(
        CGameScriptInterface_GetHeroWillLevel_TargetOverlay,
        m_Flags2C) == 0x2C);
static_assert(
    offsetof(
        CGameScriptInterface_GetHeroWillLevel_TargetOverlay,
...
using Fn_00487DC0 =
    CGameScriptInterface_GetHeroWillLevel_TargetOverlay* (__thiscall*)(void*);
...
long __thiscall CGameScriptInterface::GetHeroWillLevel() const
{
    const auto* const self =
        reinterpret_cast<
            const CGameScriptInterface_GetHeroWillLevel_SelfOverlay*>(this);
    auto* const target =
    ...
    if ((target != nullptr) && ((target->m_Flags91 & 0x01) == 0))
    {
        ...
        return pHeroExperience->GetTotalStatLevel(2);
    }
