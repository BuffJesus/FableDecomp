...
static __forceinline fable_u32 ClampDisplayDimension(
    fable_u32 maximum,
    fable_u32 value)
{
    if (maximum < value)
...
bool FABLE_FASTCALL GFInitialise()
{
    ...
    FableDisplayPrimitive* const displayPrimitive =
        g_FableDisplayPrimitive_013B8384;
    const fable_u32 maximumDimension =
        g_FableMaximumDisplayDimension_0137546C;
    g_FableDisplayWidth_013B7D64 =
        ClampDisplayDimension(
            maximumDimension,
            displayPrimitive->maximumWidth3AB0);

    g_FableDisplayHeight_013B7D60 =
        ClampDisplayDimension(
            maximumDimension,
