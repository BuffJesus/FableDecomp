...
extern char kC3DMeshFileConvexVolumeChunkDescription[];

struct C3DMeshFileConvexVolumeChunk {
    CCharString GetChunkDescription() const;
};

CCharString C3DMeshFileConvexVolumeChunk::GetChunkDescription() const {
    return CCharString(kC3DMeshFileConvexVolumeChunkDescription, -1);
}