// CCombatSequence_TrollOpeningGroundPound_Methods::GetName  @ 008b40f0
...
struct CCombatSequence_TrollOpeningGroundPound_Methods : CCombatSequence_TrollOpeningGroundPound {
    CCharString GetName() const;
};

CCharString CCombatSequence_TrollOpeningGroundPound_Methods::GetName() const
{
