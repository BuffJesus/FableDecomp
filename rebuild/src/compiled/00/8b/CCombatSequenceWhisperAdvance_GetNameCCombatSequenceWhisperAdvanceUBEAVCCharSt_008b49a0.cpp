// CCombatSequenceWhisperAdvance_Methods::GetName  (retail 0x008b49a0)
...
#include "engine/CCombatSequenceWhisperAdvance.h"  // retyped onto the PDB layout; byte parity re-verified
struct CCharString {
    char* p;
...
struct CCombatSequenceWhisperAdvance_Methods : CCombatSequenceWhisperAdvance {
    CCharString GetName() const;
};

CCharString CCombatSequenceWhisperAdvance_Methods::GetName() const
{
