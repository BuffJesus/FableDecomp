...
//   ?GetName@CCombatSequence_BattleCharge@@UBE?AVCCharString@@XZ  (0x008b5090)
//
// Retail disasm:
//   push esi
//   mov  esi, [esp+8]        ; esi = hidden return buffer (CCharString*)
//   push -1
//   push 0x1278ee4           ; const char* literal
...
class CCombatSequence_BattleCharge
{
public:
    virtual CCharString GetName() const;
};

CCharString CCombatSequence_BattleCharge::GetName() const
{
    return CCharString((const char*)0x1278ee4, -1);
}