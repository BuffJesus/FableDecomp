// CCombatSequenceJacksCombo::GetName
// retail 0x008b4e90 : __fastcall CCharString GetName(CActionDoCreatureAction*)
//
// push esi
// mov esi,[esp+8]          ; esi = hidden struct-return buffer (CCharString*)
// push -1
// push 0x1278e58           ; const char* literal
// mov ecx,esi
...
class CCombatSequenceJacksCombo {
public:
    CCharString GetName() const;
};

CCharString CCombatSequenceJacksCombo::GetName() const
{
    return CCharString((const char*)0x1278e58, -1);
}