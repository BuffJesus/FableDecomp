...
// CScriptThing::MsgIsHitByAnySpecialAbility @ 0x004aad40
// mov ecx,[ecx+4]; test; jne L; xor al,al; ret 4; L: mov eax,[ecx]; jmp [eax+0xa8]
...
bool CScriptThing::MsgIsHitByAnySpecialAbility(int a0)
{
