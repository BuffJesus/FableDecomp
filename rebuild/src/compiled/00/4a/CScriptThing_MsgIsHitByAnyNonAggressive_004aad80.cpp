...
// CScriptThing::MsgIsHitByAnyNonAggressive @ 0x004aad80
// mov ecx,[ecx+4]; test; jne L; xor al,al; ret 4; L: mov eax,[ecx]; jmp [eax+0xb0]
...
struct CScriptThing_Methods : CScriptThing { bool MsgIsHitByAnyNonAggressive(int a0); };
bool CScriptThing_Methods::MsgIsHitByAnyNonAggressive(int a0)
{
