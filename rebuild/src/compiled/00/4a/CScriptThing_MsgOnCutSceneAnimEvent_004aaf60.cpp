...
// CScriptThing::MsgOnCutSceneAnimEvent @ 0x004aaf60
// mov ecx,[ecx+4]; test; jne L; xor al,al; ret 4; L: mov eax,[ecx]; jmp [eax+0xec]
...
struct CScriptThing_Methods : CScriptThing { bool MsgOnCutSceneAnimEvent(int a0); };
bool CScriptThing_Methods::MsgOnCutSceneAnimEvent(int a0)
{
