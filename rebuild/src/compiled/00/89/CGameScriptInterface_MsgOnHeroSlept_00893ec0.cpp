...
struct Owner893ec0 { unsigned char unused00[0x1c]; TimeManager893ec0* time1c; unsigned char unused20[0x40]; MessageManager893ec0* messages60; };
struct Script893ec0 { unsigned char unused00[4]; Owner893ec0* owner04; long GetMaxWorldFrameForMessages() const; bool MsgOnHeroSlept(bool& outIsDay) const; };
bool Script893ec0::MsgOnHeroSlept(bool& outIsDay) const{long frame0=GetMaxWorldFrameForMessages();long frame1=GetMaxWorldFrameForMessages();MessageManager893ec0* manager=owner04->messages60;VisibleFilter893ec0 visible;visible.maxWorldFrame0=frame0;visible.maxWorldFrame1=frame1;TypeFilter893ec0 type;type.messageType=0x42;BoundFilter893ec0 filter;filter.filter0=&(type);filter.filter1=&(visible);Message893ec0* message=manager->FindMostRecentMessage(&(filter));if(message!=0){outIsDay=owner04->time1c->IsDay();return true;}return false;}