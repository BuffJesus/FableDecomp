...
public:
    bool GetHeroHasCurrentMarriage() const;
};
...
extern "C" void HeroStatsHasCurrentMarriage_0057ac4b();
bool __declspec(naked) CGameScriptInterface::GetHeroHasCurrentMarriage() const {
    __asm {
        push ecx
    ...
    have_entry:
        ...
        call HeroStatsHasCurrentMarriage_0057ac4b
        pop esi
        pop ecx
        ret
    no_children:
