...
struct GuiControlTreePaneOverlay
{
    ...
    void BaseDestructor();
    GuiControlTreePaneOverlay* CGuiControlTreePane_Destructor_3(unsigned char flags);
};

GuiControlTreePaneOverlay* GuiControlTreePaneOverlay::CGuiControlTreePane_Destructor_3(unsigned char flags)
{
