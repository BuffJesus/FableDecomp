class CGameScriptInterface { public: float GetBestTimeGuessTheAddition() const; };
...
float __declspec(naked) CGameScriptInterface::GetBestTimeGuessTheAddition() const { __asm {
push ecx
