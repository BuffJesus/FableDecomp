...
//   ?GetConsoleEnableFunctionName@CEngineScreenEffectGlowRenderer@@UAE?AVCCharString@@XZ  (0x00b619f0)
//
// Retail disasm:
//   push esi
//   mov  esi, [esp+8]        ; esi = hidden return buffer (CCharString*)
//   push -1
//   push 0x12a2804           ; const char* literal
...
//   ret  4
//
// A virtual GetConsoleEnableFunctionName() returning a CCharString by value,
...
class CEngineScreenEffectGlowRenderer
{
public:
...
{
    return CCharString((const char*)0x12a2804, -1);
}