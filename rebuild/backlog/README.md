...
|---:|---|---|---:|---:|---:|---:|
| 1 | candidate-cluster | `CGameScriptInterface` | 954 | 6 | 363 | 0 |
...
| 3 | `004d55d0` | `CTCCoopSpirit` | 0 | 308 | 'CTCCoopSpirit' does not name a type |
| 4 | `00892f10` | `CGameScriptInterface` | 0 | 394 | expected '(' before '{' token |
| 5 | `00891540` | `CGameScriptInterface` | 0 | 446 | invalid use of incomplete type 'class CGameScriptInterface' |
| 6 | `00449b60` | `CPlayerManager` | 0 | 455 | 'CRGBColour' does not name a type |
| 7 | `008a9e30` | `CGameScriptInterface` | 0 | 489 | invalid use of incomplete type 'class CGameScriptInterface' |
| 8 | `008917f0` | `CGameScriptInterface` | 0 | 525 |  |
| 9 | `008914e0` | `CGameScriptInterface` | 0 | 526 |  |
| 10 | `00893030` | `CGameScriptInterface` | 0 | 553 | 'reinterpret_cast' from integer to pointer |
| 11 | `00c20ef0` | `_global` | 0 | 582 |  |
| 12 | `0088f910` | `CGameScriptInterface` | 0 | 586 |  |
| 13 | `0088f920` | `CGameScriptInterface` | 0 | 588 |  |
| 14 | `00892f40` | `CGameScriptInterface` | 0 | 593 | 'reinterpret_cast' from integer to pointer |
| 15 | `00892f70` | `CGameScriptInterface` | 0 | 593 | 'reinterpret_cast' from integer to pointer |
...
| 18 | `0088e130` | `CGameScriptInterface` | candidate-compile |  |
| 19 | `0088e2a0` | `CGameScriptInterface` | candidate-compile | static assertion failed |
| 20 | `0088e300` | `CGameScriptInterface` | candidate-compile |  |
| 21 | `0088e3d0` | `CGameScriptInterface` | candidate-compile | invalid use of incomplete type 'class CGameScriptInterface' |
| 22 | `0088e6f0` | `CGameScriptInterface` | candidate-compile |  |
| 23 | `0088ead0` | `CGameScriptInterface` | candidate-compile | invalid use of incomplete type 'class CGameScriptInterface' |
| 24 | `0088ece0` | `CGameScriptInterface` | candidate-compile |  |
| 25 | `0088f400` | `CGameScriptInterface` | candidate-compile |  |
| 26 | `0088f480` | `CGameScriptInterface` | candidate-compile |  |
| 27 | `0088f570` | `CGameScriptInterface` | candidate-compile |  |
| 28 | `0088f610` | `CGameScriptInterface` | candidate-compile |  |
| 29 | `0088f710` | `CGameScriptInterface` | candidate-compile |  |
| 30 | `0088f8d0` | `CGameScriptInterface` | candidate-compile |  |
| 31 | `0088f910` | `CGameScriptInterface` | candidate-compile |  |
| 32 | `0088f920` | `CGameScriptInterface` | candidate-compile |  |
| 33 | `0088f970` | `CGameScriptInterface` | candidate-compile |  |
| 34 | `0088f9b0` | `CGameScriptInterface` | candidate-compile |  |
| 35 | `0088fc90` | `CGameScriptInterface` | candidate-compile |  |
| 36 | `0088fd00` | `CGameScriptInterface` | candidate-compile |  |
| 37 | `0088fdc0` | `CGameScriptInterface` | candidate-compile |  |
| 38 | `0088fe30` | `CGameScriptInterface` | candidate-compile | expected '(' before '{' token |
| 39 | `0088fe40` | `CGameScriptInterface` | candidate-compile | invalid use of incomplete type 'class CGameScriptInterface' |
| 40 | `0088fe90` | `CGameScriptInterface` | candidate-compile |  |
