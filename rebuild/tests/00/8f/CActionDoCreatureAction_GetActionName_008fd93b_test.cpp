...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x008fd93b.
...
struct FableCharStringResult_008fd93b
{
...
void* FableCharStringResult_008fd93b::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_008fd93b* FABLE_FASTCALL
FableGetActionName_008fd93b(FableCharStringResult_008fd93b* self, void*);

int main()
{
    FableCharStringResult_008fd93b r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_008fd93b* got = FableGetActionName_008fd93b(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_008fd93b_OK\n");
    return 0;
}