...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x008fd83b.
...
struct FableCharStringResult_008fd83b
{
...
void* FableCharStringResult_008fd83b::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_008fd83b* FABLE_FASTCALL
FableGetActionName_008fd83b(FableCharStringResult_008fd83b* self, void*);

int main()
{
    FableCharStringResult_008fd83b r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_008fd83b* got = FableGetActionName_008fd83b(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_008fd83b_OK\n");
    return 0;
}