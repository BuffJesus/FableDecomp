...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x008fd86d.
...
struct FableCharStringResult_008fd86d
{
...
void* FableCharStringResult_008fd86d::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_008fd86d* FABLE_FASTCALL
FableGetActionName_008fd86d(FableCharStringResult_008fd86d* self, void*);

int main()
{
    FableCharStringResult_008fd86d r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_008fd86d* got = FableGetActionName_008fd86d(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_008fd86d_OK\n");
    return 0;
}