...
{
    {
        CWideString value = FableGetShadersDirectory_0041A1E0();
        if (g_constructedText == 0 ||
            wcscmp(g_constructedText, L"Data\\Shaders\\") != 0)
        {
            printf("FABLETLC_SHADERS_DIRECTORY_BEHAVIOR FAIL\n");
            return 1;
        }
    }
    printf("FABLETLC_SHADERS_DIRECTORY_BEHAVIOR PASS\n");
    return 0;
}
