...
{
    AutoTinyFirstMemberDestructor(static_cast<unsigned char*>(self) + 104);
    AutoTinySecondMemberDestructor(static_cast<unsigned char*>(self) + 100);
...
int main()
{
    ...
    if (CThingSwitch_CompositeScalarDeletingDestructor(object, 0, 0) != object ||
        g_AutoTinyFirstMember != object + 104 ||
        g_AutoTinySecondMember != object + 100 ||
    ...
    if (g_AutoTinySequenceCount != 6 ||
        ...
        return 1;
    std::printf("AUTO_TINY_00e9fba0_TEST PASS\n");
    return 0;
}