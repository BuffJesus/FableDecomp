...
{
    AutoTinyFirstMemberDestructor(static_cast<unsigned char*>(self) + 120);
...
int main()
{
    ...
    if (CThingSwitch_CompositeScalarDeletingDestructor(object, 0, 0) != object ||
        g_AutoTinyFirstMember != object + 120 ||
        g_AutoTinySecondMember != object + 72 ||
    ...
    if (g_AutoTinySequenceCount != 6 ||
        ...
        return 1;
    std::printf("AUTO_TINY_00e0afb0_TEST PASS\n");
    return 0;
}