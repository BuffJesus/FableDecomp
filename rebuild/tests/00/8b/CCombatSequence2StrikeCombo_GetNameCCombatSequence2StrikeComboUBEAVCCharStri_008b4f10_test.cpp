...
CCharString CCombatSequence2StrikeCombo::GetName()
{
    CCharString ret;
    CCharString_ctor(&ret, 0, "2StrikeCombo", -1);
    return ret;
}

int main()
{
    CCombatSequence2StrikeCombo obj;
    ...
    if (ok) printf("STRIKECOMBO_GETNAME_OK\n");
