...
{
    AutoTinyFirstMemberDestructor(static_cast<unsigned char*>(self) + 116);
    AutoTinySecondMemberDestructor(static_cast<unsigned char*>(self) + 104);
...
int main()
{
    ...
    if (CThingSwitch_CompositeScalarDeletingDestructor(object, 0, 0) != object ||
        g_AutoTinyFirstMember != object + 116 ||
        g_AutoTinySecondMember != object + 104 ||
    ...
    if (g_AutoTinySequenceCount != 6 ||
        ...
        return 1;
    std::printf("AUTO_TINY_00741980_TEST PASS\n");
    return 0;
}