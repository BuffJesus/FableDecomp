...
// Local stand-in for the 0x99f570 helper.
...
int main()
{
    ...
    bool ok = true;
    if (g_lastField != (void*)&obj.m_field4) ok = false;
    if (g_lastLit  != (const char*)0x13caa48) ok = false;
    if (r.p != (void*)0xABCD1234) ok = false;
