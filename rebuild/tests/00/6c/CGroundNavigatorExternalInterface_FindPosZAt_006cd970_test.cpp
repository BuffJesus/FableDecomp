...
float CThingCreatureBase::FindPosZ(const C3DVector& pos, int flag, bool b)
{
    if (this != (CThingCreatureBase*)0x12345678) { printf("BAD this "); return 0.0f; }
...
int main()
{
    ...
    self.Creature = (CThingCreatureBase*)0x12345678;
