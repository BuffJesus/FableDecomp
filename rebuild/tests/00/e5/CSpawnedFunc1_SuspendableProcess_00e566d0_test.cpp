...
#include <cstdio>
static void *g_seen_00e566d0 = 0;
struct CSpawnTarget { void Invoke(void *arg){ g_seen_00e566d0 = arg; } };
...
int main(){
    ...
    if(s.m_started!=1||g_seen_00e566d0!=(void*)0x1234){std::printf("BAD\n");return 1;}
    std::printf("SUSPEND66D0_OK\n"); return 0;
}