...
char P::tgt(int a0, int a1){ return 1; }
char S::M(int a0, int a1){ P* p=this->f4; if(!p) return 0; return p->tgt(a0, a1); }
int main(){ P pp; S o; o.f4=&pp;
 if(o.M(0, 0)!=1){ std::printf("004aabb0_TEST FAIL\n"); return 1;}
 S o2; o2.f4=0; if(o2.M(0, 0)!=0){ std::printf("004aabb0_TEST FAIL\n"); return 1;}
 std::printf("004aabb0_TEST PASS\n"); return 0;}