...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x004d48ee.
...
struct FableCharStringResult_004d48ee
{
...
void* FableCharStringResult_004d48ee::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_004d48ee* FABLE_FASTCALL
FableGetActionName_004d48ee(FableCharStringResult_004d48ee* self, void*);

int main()
{
    FableCharStringResult_004d48ee r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_004d48ee* got = FableGetActionName_004d48ee(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_004d48ee_OK\n");
    return 0;
}