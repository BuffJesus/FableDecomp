...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x004d48be.
...
struct FableCharStringResult_004d48be
{
...
void* FableCharStringResult_004d48be::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_004d48be* FABLE_FASTCALL
FableGetActionName_004d48be(FableCharStringResult_004d48be* self, void*);

int main()
{
    FableCharStringResult_004d48be r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_004d48be* got = FableGetActionName_004d48be(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_004d48be_OK\n");
    return 0;
}