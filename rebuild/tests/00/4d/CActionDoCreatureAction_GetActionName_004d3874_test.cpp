...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x004d3874.
...
struct FableCharStringResult_004d3874
{
...
void* FableCharStringResult_004d3874::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_004d3874* FABLE_FASTCALL
FableGetActionName_004d3874(FableCharStringResult_004d3874* self, void*);

int main()
{
    FableCharStringResult_004d3874 r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_004d3874* got = FableGetActionName_004d3874(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_004d3874_OK\n");
    return 0;
}