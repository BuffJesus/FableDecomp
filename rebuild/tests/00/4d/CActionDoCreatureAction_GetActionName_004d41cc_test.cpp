...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x004d41cc.
...
struct FableCharStringResult_004d41cc
{
...
void* FableCharStringResult_004d41cc::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_004d41cc* FABLE_FASTCALL
FableGetActionName_004d41cc(FableCharStringResult_004d41cc* self, void*);

int main()
{
    FableCharStringResult_004d41cc r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_004d41cc* got = FableGetActionName_004d41cc(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_004d41cc_OK\n");
    return 0;
}