...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x004d627f.
...
struct FableCharStringResult_004d627f
{
...
void* FableCharStringResult_004d627f::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_004d627f* FABLE_FASTCALL
FableGetActionName_004d627f(FableCharStringResult_004d627f* self, void*);

int main()
{
    FableCharStringResult_004d627f r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_004d627f* got = FableGetActionName_004d627f(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_004d627f_OK\n");
    return 0;
}