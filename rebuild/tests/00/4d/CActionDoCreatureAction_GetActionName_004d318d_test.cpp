...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x004d318d.
...
struct FableCharStringResult_004d318d
{
...
void* FableCharStringResult_004d318d::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_004d318d* FABLE_FASTCALL
FableGetActionName_004d318d(FableCharStringResult_004d318d* self, void*);

int main()
{
    FableCharStringResult_004d318d r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_004d318d* got = FableGetActionName_004d318d(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_004d318d_OK\n");
    return 0;
}