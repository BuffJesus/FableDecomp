...
// Behaviour fixture for CActionDoCreatureAction::GetActionName @ 0x004d53ee.
...
struct FableCharStringResult_004d53ee
{
...
void* FableCharStringResult_004d53ee::build(const char* text, int length)
{
    seen_text = text;
    seen_len = length;
    return this;
...
extern "C" FableCharStringResult_004d53ee* FABLE_FASTCALL
FableGetActionName_004d53ee(FableCharStringResult_004d53ee* self, void*);

int main()
{
    FableCharStringResult_004d53ee r;
    r.seen_text = 0;
    r.seen_len = 0;
    FableCharStringResult_004d53ee* got = FableGetActionName_004d53ee(&r, 0);
    if (got != &r) { std::printf("BAD_IDENTITY\n"); return 1; }
    if (r.seen_len != -1) { std::printf("BAD_LEN\n"); return 1; }
    if (r.seen_text == 0) { std::printf("BAD_TEXT\n"); return 1; }
    std::printf("GETACTIONNAME_004d53ee_OK\n");
    return 0;
}