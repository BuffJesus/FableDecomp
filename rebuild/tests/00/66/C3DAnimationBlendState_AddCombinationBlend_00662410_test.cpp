...
extern "C" Obj *FABLE_FASTCALL FableGet_662410(C3DAnimationBlendState *self){ g_obj.m_sub=&g_sub; return &g_obj; }
struct C3DAnimationBlendState { char dummy; void AddCombinationBlend(); };
void C3DAnimationBlendState::AddCombinationBlend(){ Sub *s=FableGet_662410(this)->m_sub; s->Add(this); }
int main(){ C3DAnimationBlendState o; o.AddCombinationBlend();
 if(!g_added){std::printf("B1\n");return 1;}
 std::printf("AC_662410_OK\n"); return 0; }