...
void FABLE_FASTCALL FableDestVal_00765d20_t::inner() { g_inner++; }
void FABLE_FASTCALL FableDestVal_00765d20_t::outer() { g_outer++; }
extern "C" void FABLE_FASTCALL FableDestVal_00765d20(FableDestVal_00765d20_t* self);
int main()
{
    char buf[0x4 + 8];
    FableDestVal_00765d20((FableDestVal_00765d20_t*)buf);
    if (g_inner != 1) { std::printf("BAD_INNER\n"); return 1; }
    if (g_outer != 1) { std::printf("BAD_OUTER\n"); return 1; }
    std::printf("DESTVAL_00765d20_OK\n");
    return 0;
}