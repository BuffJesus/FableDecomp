...
int main()
{
    ...
    g_calls[0] = 0;
    g_mapNumber = 0;
    if (worldMap->GetThemeAtBlock(worldCoord, 12, EThemePaintType_Replace) != 0) return 1;
    ...
    g_mapNumber = 5;
    g_peekSawNumber = 0;
    if (worldMap->GetThemeAtBlock(worldCoord, 12, EThemePaintType_Replace) != 0xA1B2C3D4UL) return 3;
    ...
    printf("WORLD_MAP_GET_THEME_TEST PASS\n");
    return 0;
}
