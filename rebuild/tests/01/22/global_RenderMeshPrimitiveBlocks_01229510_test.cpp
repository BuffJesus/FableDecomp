...
int main()
{
    ...
    if (g_AutoTinyMethodOptionalCalls == 1 && g_AutoTinyMethodOptionalObserved == g_AutoTinyMethodOptionalPointer) { std::printf("AUTO_TINY_01229510_TEST PASS\n"); return 0; }
    std::printf("AUTO_TINY_01229510_TEST FAIL\n");
    return 1;
}