...
| VC7.1 compiled candidate | 5,498 | 49,568 | 11.092% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 5,498 | 49,568 | 11.092% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 2,991 | 49,568 | 6.034% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 2,338 | 49,568 | 4.717% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 5,347 | 49,568 | 10.787% | Compiled under VC7.1 and checked against retail |
| Byte-identical C++ | 3,007 | 49,568 | 6.066% | Exact `.text` match |
