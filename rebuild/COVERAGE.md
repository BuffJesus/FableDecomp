...
| VC7.1 compiled candidate | 18,796 | 49,568 | 37.920% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 18,796 | 49,568 | 37.920% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 8,075 | 49,568 | 16.291% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 10,625 | 49,568 | 21.435% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 18,718 | 49,568 | 37.762% | Compiled under VC7.1 and checked against retail |
| Byte-identical C++ | 8,091 | 49,568 | 16.323% | Exact `.text` match (includes asm bakes below) |
| Byte-identical **genuine** C++ | 7,799 | 49,568 | 15.734% | Exact match from real compiler input; no `__asm`, `naked`, `_emit` |
...
| Matched retail bytes (genuine C++) | 387,218 | — | — | Bytes of retail `.text` reproduced by genuine landings |
