...
Generated: `2026-09-08T12:22:38-06:00`
...
| VC7.1 compiled candidate | 18,836 | 49,568 | 38.000% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 18,836 | 49,568 | 38.000% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 8,095 | 49,568 | 16.331% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 10,645 | 49,568 | 21.476% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 18,758 | 49,568 | 37.843% | Compiled under VC7.1 and checked against retail |
| Byte-identical C++ | 8,111 | 49,568 | 16.363% | Exact `.text` match (includes asm bakes below) |
| Byte-identical **genuine** C++ | 7,819 | 49,568 | 15.774% | Exact match from real compiler input; no `__asm`, `naked`, `_emit` |
...
| Matched retail bytes (genuine C++) | 388,678 | — | — | Bytes of retail `.text` reproduced by genuine landings |
