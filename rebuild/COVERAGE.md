...
Generated: `2026-07-26T00:02:36-06:00`
...
| VC7.1 compiled candidate | 3,308 | 49,553 | 6.676% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 3,308 | 49,553 | 6.676% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 1,895 | 49,553 | 3.824% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 1,086 | 49,553 | 2.192% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 2,999 | 49,553 | 6.052% | Compiled under VC7.1 and checked against retail |
