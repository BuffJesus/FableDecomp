...
| VC7.1 compiled candidate | 18,661 | 49,568 | 37.647% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 18,661 | 49,568 | 37.647% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 8,066 | 49,568 | 16.273% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 10,499 | 49,568 | 21.181% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 18,583 | 49,568 | 37.490% | Compiled under VC7.1 and checked against retail |
