...
| VC7.1 compiled candidate | 18,674 | 49,568 | 37.673% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 18,674 | 49,568 | 37.673% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 8,066 | 49,568 | 16.273% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 10,512 | 49,568 | 21.207% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 18,596 | 49,568 | 37.516% | Compiled under VC7.1 and checked against retail |
