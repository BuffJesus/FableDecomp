...
Generated: `2026-09-08T11:46:39-06:00`
...
| VC7.1 compiled candidate | 18,833 | 49,568 | 37.994% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 18,833 | 49,568 | 37.994% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 8,093 | 49,568 | 16.327% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 10,644 | 49,568 | 21.474% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 18,755 | 49,568 | 37.837% | Compiled under VC7.1 and checked against retail |
| Byte-identical C++ | 8,109 | 49,568 | 16.359% | Exact `.text` match (includes asm bakes below) |
| Byte-identical **genuine** C++ | 7,817 | 49,568 | 15.770% | Exact match from real compiler input; no `__asm`, `naked`, `_emit` |
...
| Matched retail bytes (genuine C++) | 388,555 | — | — | Bytes of retail `.text` reproduced by genuine landings |
