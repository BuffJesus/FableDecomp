...
Generated: `2026-09-08T18:17:42-06:00`
...
| VC7.1 compiled candidate | 18,864 | 49,568 | 38.057% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 18,864 | 49,568 | 38.057% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 8,142 | 49,568 | 16.426% | Generated-candidate track exact matches awaiting promotion |
...
| Verified functional or matching C++ | 18,838 | 49,568 | 38.004% | Compiled under VC7.1 and checked against retail |
| Byte-identical C++ | 8,158 | 49,568 | 16.458% | Exact `.text` match (includes asm bakes below) |
| Byte-identical **genuine** C++ | 7,866 | 49,568 | 15.869% | Exact match from real compiler input; no `__asm`, `naked`, `_emit` |
| Hand-written asm bakes (grade `asm_bake`) | 292 | 601 | — | Byte-exact oracles, **not** reconstruction; de-bake worklist |
| Landed sources typed onto shared engine headers | 683 | 14,690 | 4.649% | `#include "engine/<Class>.h"` with PDB member names (965 headers) |
| Generic local struct declarations remaining | 4,410 | — | — | `struct T/Sub/Owner...` throwaways in 3,271 files; retype worklist |
| Matched retail bytes (genuine C++) | 393,852 | — | — | Bytes of retail `.text` reproduced by genuine landings |
