...
| VC7.1 compiled candidate | 18,808 | 49,568 | 37.944% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 18,808 | 49,568 | 37.944% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 8,080 | 49,568 | 16.301% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 10,632 | 49,568 | 21.449% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 18,730 | 49,568 | 37.786% | Compiled under VC7.1 and checked against retail |
| Byte-identical C++ | 8,096 | 49,568 | 16.333% | Exact `.text` match (includes asm bakes below) |
| Byte-identical **genuine** C++ | 7,804 | 49,568 | 15.744% | Exact match from real compiler input; no `__asm`, `naked`, `_emit` |
...
| Matched retail bytes (genuine C++) | 387,642 | — | — | Bytes of retail `.text` reproduced by genuine landings |
