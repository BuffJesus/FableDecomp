...
Generated: `2026-07-26T10:05:58-06:00`
...
| VC7.1 compiled candidate | 4,870 | 49,553 | 9.828% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 4,870 | 49,553 | 9.828% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 2,672 | 49,553 | 5.392% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 1,871 | 49,553 | 3.776% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 4,561 | 49,553 | 9.204% | Compiled under VC7.1 and checked against retail |
