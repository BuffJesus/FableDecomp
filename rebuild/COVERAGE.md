...
| VC7.1 compiled candidate | 18,755 | 49,568 | 37.837% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 18,755 | 49,568 | 37.837% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 8,074 | 49,568 | 16.289% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 10,585 | 49,568 | 21.355% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 18,677 | 49,568 | 37.680% | Compiled under VC7.1 and checked against retail |
| Byte-identical C++ | 8,090 | 49,568 | 16.321% | Exact `.text` match (includes asm bakes below) |
| Byte-identical **genuine** C++ | 7,798 | 49,568 | 15.732% | Exact match from real compiler input; no `__asm`, `naked`, `_emit` |
...
| Matched retail bytes (genuine C++) | 385,823 | — | — | Bytes of retail `.text` reproduced by genuine landings |
