...
Generated: `2026-09-08T12:41:51-06:00`
...
| VC7.1 compiled candidate | 18,842 | 49,568 | 38.012% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 18,842 | 49,568 | 38.012% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 8,099 | 49,568 | 16.339% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 10,647 | 49,568 | 21.480% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 18,764 | 49,568 | 37.855% | Compiled under VC7.1 and checked against retail |
| Byte-identical C++ | 8,115 | 49,568 | 16.371% | Exact `.text` match (includes asm bakes below) |
| Byte-identical **genuine** C++ | 7,823 | 49,568 | 15.782% | Exact match from real compiler input; no `__asm`, `naked`, `_emit` |
| Hand-written asm bakes (grade `asm_bake`) | 292 | 601 | — | Byte-exact oracles, **not** reconstruction; de-bake worklist |
| Landed sources typed onto shared engine headers | 667 | 14,488 | 4.604% | `#include "engine/<Class>.h"` with PDB member names (962 headers) |
| Generic local struct declarations remaining | 4,410 | — | — | `struct T/Sub/Owner...` throwaways in 3,271 files; retype worklist |
| Matched retail bytes (genuine C++) | 388,929 | — | — | Bytes of retail `.text` reproduced by genuine landings |
