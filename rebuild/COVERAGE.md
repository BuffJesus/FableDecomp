...
Generated: `2026-07-30T15:47:58-06:00`
...
| VC7.1 compiled candidate | 5,470 | 49,568 | 11.035% | Compiles to an object; behavioral parity not yet claimed |
| Behavior-tested candidate | 5,470 | 49,568 | 11.035% | Local branch/layout oracle passes; retail parity not yet claimed |
| Candidate retail `.text` match | 2,971 | 49,568 | 5.994% | Generated-candidate track exact matches awaiting promotion |
| Candidate relocation-masked `.text` match | 2,330 | 49,568 | 4.701% | Exact instruction bytes/layout after masking expected COFF linker fields |
| Verified functional or matching C++ | 5,319 | 49,568 | 10.731% | Compiled under VC7.1 and checked against retail |
| Byte-identical C++ | 2,987 | 49,568 | 6.026% | Exact `.text` match |
