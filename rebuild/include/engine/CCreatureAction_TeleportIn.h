#ifndef FABLE_ENGINE_CCREATUREACTION_TELEPORTIN_H
#define FABLE_ENGINE_CCREATUREACTION_TELEPORTIN_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_TeleportIn = 0x130.
...
#pragma pack(push, 1)
struct CCreatureAction_TeleportIn {
    ...
    bool          CreateEffects;                             // +0x12c
    unsigned char _pad_0x12d[0x3];                           // +0x12d
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_TeleportIn) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_TeleportIn, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_TeleportIn, CreateEffects) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_TELEPORTIN_H
