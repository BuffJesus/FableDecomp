#ifndef FABLE_ENGINE_CCREATUREACTION_BANDITKINGUNSTUCK_H
#define FABLE_ENGINE_CCREATUREACTION_BANDITKINGUNSTUCK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_BanditKingUnstuck = 0x130.
...
#pragma pack(push, 1)
struct CCreatureAction_BanditKingUnstuck {
    ...
    unsigned char f;                                         // +0x114 retail-only (CCreatureActionBanditKingUnstuck_IsKnockdownStrike_008c9610.cpp)
    ...
    bool          Knockdown;                                 // +0x12c
    bool          NoTarget;                                  // +0x12d
    unsigned char _pad_0x12e[0x2];                           // +0x12e
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_BanditKingUnstuck) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingUnstuck, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingUnstuck, f) == 0x114);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingUnstuck, Knockdown) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingUnstuck, NoTarget) == 0x12d);

#endif // FABLE_ENGINE_CCREATUREACTION_BANDITKINGUNSTUCK_H
