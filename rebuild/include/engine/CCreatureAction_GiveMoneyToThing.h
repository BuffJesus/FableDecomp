#ifndef FABLE_ENGINE_CCREATUREACTION_GIVEMONEYTOTHING_H
#define FABLE_ENGINE_CCREATUREACTION_GIVEMONEYTOTHING_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_GiveMoneyToThing = 0xc0.
...
#pragma pack(push, 1)
struct CCreatureAction_GiveMoneyToThing {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_GiveMoneyToThing) == 0xc0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GiveMoneyToThing, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GiveMoneyToThing, PReceivingThing) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GiveMoneyToThing, Amount) == 0xbc);

#endif // FABLE_ENGINE_CCREATUREACTION_GIVEMONEYTOTHING_H
