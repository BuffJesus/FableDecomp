#ifndef FABLE_ENGINE_CFRONTENDSCREEN_H
#define FABLE_ENGINE_CFRONTENDSCREEN_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CFrontEndScreen = 0x19c.
...
struct CFrontEndScreen {
    ...
    float           m_fLastInputTime;                        // +0x18c
    CAction*        PLeftClickAction_Data;                   // +0x190 CCountedPointer<NUISystem::CAction>::Data
    CCPPointerInfo* PLeftClickAction_Info;                   // +0x194 CCountedPointer<NUISystem::CAction>::Info
    CComponent*     PAcceptButton;                           // +0x198
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CFrontEndScreen) == 0x19c);
FABLE_STATIC_ASSERT(offsetof(CFrontEndScreen, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CFrontEndScreen, m_fLastInputTime) == 0x18c);
FABLE_STATIC_ASSERT(offsetof(CFrontEndScreen, PLeftClickAction_Data) == 0x190);
FABLE_STATIC_ASSERT(offsetof(CFrontEndScreen, PLeftClickAction_Info) == 0x194);
FABLE_STATIC_ASSERT(offsetof(CFrontEndScreen, PAcceptButton) == 0x198);

#endif // FABLE_ENGINE_CFRONTENDSCREEN_H
