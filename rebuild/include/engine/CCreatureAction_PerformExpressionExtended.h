#ifndef FABLE_ENGINE_CCREATUREACTION_PERFORMEXPRESSIONEXTENDED_H
#define FABLE_ENGINE_CCREATUREACTION_PERFORMEXPRESSIONEXTENDED_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_PerformExpressionExtended = 0xd4.
...
#pragma pack(push, 1)
struct CCreatureAction_PerformExpressionExtended {
    ...
    void*         p;                                         // +0xa8 retail-only (CCreatureActionPerformExpression_IsToReplaceItemIfRemovedExt_00842c40.cpp)
    ...
    long          FrameCount;                                // +0xc8
    bool          ReplacedAction;                            // +0xcc
    unsigned char _pad_0xcd[0x3];                            // +0xcd
    unsigned long SoundEffectID;                             // +0xd0
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_PerformExpressionExtended) == 0xd4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PerformExpressionExtended, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PerformExpressionExtended, p) == 0xa8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PerformExpressionExtended, PExpressionDef) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PerformExpressionExtended, PPerformToThing) == 0xb8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PerformExpressionExtended, ExpressionItemDefIndex) == 0xc0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PerformExpressionExtended, EmoteIconAdded) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PerformExpressionExtended, FrameCount) == 0xc8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PerformExpressionExtended, ReplacedAction) == 0xcc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PerformExpressionExtended, SoundEffectID) == 0xd0);

#endif // FABLE_ENGINE_CCREATUREACTION_PERFORMEXPRESSIONEXTENDED_H
