#ifndef FABLE_ENGINE_CCREATUREACTION_TALK_H
#define FABLE_ENGINE_CCREATUREACTION_TALK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_Talk = 0xbc.
...
struct CCreatureAction_Talk {
    ...
    unsigned char PTalkToThing[0x8];                         // +0xb4 CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_Talk) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_Talk, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_Talk, PTalkToThing) == 0xb4);

#endif // FABLE_ENGINE_CCREATUREACTION_TALK_H
