#ifndef FABLE_ENGINE_CCREATUREACTION_UNSHEATHEWEAPONS_H
#define FABLE_ENGINE_CCREATUREACTION_UNSHEATHEWEAPONS_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_UnsheatheWeapons = 0x130.
...
struct CCreatureAction_UnsheatheWeapons {
    ...
    unsigned char WeaponType[0x4];                           // +0x12c EUnsheatheWeaponType
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_UnsheatheWeapons) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheWeapons, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheWeapons, WeaponType) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_UNSHEATHEWEAPONS_H
