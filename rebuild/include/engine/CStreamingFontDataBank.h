#ifndef FABLE_ENGINE_CSTREAMINGFONTDATABANK_H
#define FABLE_ENGINE_CSTREAMINGFONTDATABANK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CStreamingFontDataBank = 0x208.
...
struct CStreamingFontDataBank {
    ...
    unsigned char        StateBlock[0x14];                   // +0x1d8 CStreamingFontBankStateBlock
    unsigned char        Fonts[0x10];                        // +0x1ec CArray<CStreamingFontDataBankEntry_*>
    CCharStringData*     Filename_PStringData;               // +0x1fc CCharString::PStringData
    CBankFileAsyncEntry* streamingEntry_Data;                // +0x200 CCountedPointer<CBankFileAsyncEntry>::Data
    CCPPointerInfo*      streamingEntry_Info;                // +0x204 CCountedPointer<CBankFileAsyncEntry>::Info
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CStreamingFontDataBank) == 0x208);
FABLE_STATIC_ASSERT(offsetof(CStreamingFontDataBank, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CStreamingFontDataBank, StateBlock) == 0x1d8);
FABLE_STATIC_ASSERT(offsetof(CStreamingFontDataBank, Fonts) == 0x1ec);
FABLE_STATIC_ASSERT(offsetof(CStreamingFontDataBank, Filename_PStringData) == 0x1fc);
FABLE_STATIC_ASSERT(offsetof(CStreamingFontDataBank, streamingEntry_Data) == 0x200);
FABLE_STATIC_ASSERT(offsetof(CStreamingFontDataBank, streamingEntry_Info) == 0x204);

#endif // FABLE_ENGINE_CSTREAMINGFONTDATABANK_H
