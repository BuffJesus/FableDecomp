...
struct CStreamingFontDataBank {
    ...
    unsigned char Filename[0x4];                             // +0x1fc CCharString
    unsigned char streamingEntry[0x8];                       // +0x200 CCountedPointer<CBankFileAsyncEntry>
};
#pragma pack(pop)
...
FABLE_STATIC_ASSERT(offsetof(CStreamingFontDataBank, Filename) == 0x1fc);
FABLE_STATIC_ASSERT(offsetof(CStreamingFontDataBank, streamingEntry) == 0x200);
