#ifndef FABLE_ENGINE_CCREATUREACTION_CASTSTRENGTHMULTISTRIKE_H
#define FABLE_ENGINE_CCREATUREACTION_CASTSTRENGTHMULTISTRIKE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_CastStrengthMultiStrike = 0x130.
...
struct CCreatureAction_CastStrengthMultiStrike {
    ...
    long          NumberOfStrikes;                           // +0x12c
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_CastStrengthMultiStrike) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastStrengthMultiStrike, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastStrengthMultiStrike, NumberOfStrikes) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_CASTSTRENGTHMULTISTRIKE_H
