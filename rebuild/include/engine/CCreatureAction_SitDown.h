#ifndef FABLE_ENGINE_CCREATUREACTION_SITDOWN_H
#define FABLE_ENGINE_CCREATUREACTION_SITDOWN_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_SitDown = 0xbc.
...
#pragma pack(push, 1)
struct CCreatureAction_SitDown {
    ...
    CModeSitBase*   PSitMode_Data;                           // +0xb4 CCountedPointer<NCreatureMode::CModeSitBase>::Data
    CCPPointerInfo* PSitMode_Info;                           // +0xb8 CCountedPointer<NCreatureMode::CModeSitBase>::Info
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_SitDown) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_SitDown, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_SitDown, PSitMode_Data) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_SitDown, PSitMode_Info) == 0xb8);

#endif // FABLE_ENGINE_CCREATUREACTION_SITDOWN_H
