#ifndef FABLE_ENGINE_CCREATUREACTION_SHEATHEITEMTOINVENTORY_H
#define FABLE_ENGINE_CCREATUREACTION_SHEATHEITEMTOINVENTORY_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_SheatheItemToInventory = 0xbc.
...
#pragma pack(push, 1)
struct CCreatureAction_SheatheItemToInventory {
    ...
    CCreatureActionBase* PFollowUpAction_Data;               // +0xb4 CCountedPointer<CCreatureActionBase>::Data
    CCPPointerInfo*      PFollowUpAction_Info;               // +0xb8 CCountedPointer<CCreatureActionBase>::Info
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_SheatheItemToInventory) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_SheatheItemToInventory, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_SheatheItemToInventory, PFollowUpAction_Data) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_SheatheItemToInventory, PFollowUpAction_Info) == 0xb8);

#endif // FABLE_ENGINE_CCREATUREACTION_SHEATHEITEMTOINVENTORY_H
