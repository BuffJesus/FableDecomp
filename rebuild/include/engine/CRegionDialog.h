#ifndef FABLE_ENGINE_CREGIONDIALOG_H
#define FABLE_ENGINE_CREGIONDIALOG_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CRegionDialog = 0x144.
...
struct CGuiControlButton;
struct CGuiWindowBox;
...
struct CRegionDialog {
    ...
    CEditControlCentre* ControlCentre;                       // +0x128
    CGuiWindowBox*      RegionSettingsWindow;                // +0x12c
    CGuiControlButton*  PSelectedRegionButton;               // +0x130
    long                SelectedRegionNode;                  // +0x134
    long                UnassignedRegionNode;                // +0x138
    bool                DoNotCallContentsChanged;            // +0x13c
    bool                IsInVisibilityMode;                  // +0x13d
    unsigned char       _pad_0x13e[0x2];                     // +0x13e
    unsigned char       State[0x4];                          // +0x140 <unnamed-type-State>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CRegionDialog) == 0x144);
FABLE_STATIC_ASSERT(offsetof(CRegionDialog, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CRegionDialog, ControlCentre) == 0x128);
FABLE_STATIC_ASSERT(offsetof(CRegionDialog, RegionSettingsWindow) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CRegionDialog, PSelectedRegionButton) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CRegionDialog, SelectedRegionNode) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CRegionDialog, UnassignedRegionNode) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CRegionDialog, DoNotCallContentsChanged) == 0x13c);
FABLE_STATIC_ASSERT(offsetof(CRegionDialog, IsInVisibilityMode) == 0x13d);
FABLE_STATIC_ASSERT(offsetof(CRegionDialog, State) == 0x140);

#endif // FABLE_ENGINE_CREGIONDIALOG_H
