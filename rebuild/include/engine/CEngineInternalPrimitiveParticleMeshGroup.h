#ifndef FABLE_ENGINE_CENGINEINTERNALPRIMITIVEPARTICLEMESHGROUP_H
#define FABLE_ENGINE_CENGINEINTERNALPRIMITIVEPARTICLEMESHGROUP_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CEngineInternalPrimitiveParticleMeshGroup = 0xfc.
...
#pragma pack(push, 1)
struct CEngineInternalPrimitiveParticleMeshGroup {
    ...
    C3DMeshInfo*  MeshInfo;                                  // +0xc0
    unsigned char WorldTransform[0x30];                      // +0xc4 CMatrix3x4
    unsigned char BlendOp[0x4];                              // +0xf4 EEnginePrimitiveBlendOp
    unsigned char BlendMode[0x4];                            // +0xf8 EEnginePrimitiveBlendMode
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CEngineInternalPrimitiveParticleMeshGroup) == 0xfc);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveParticleMeshGroup, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveParticleMeshGroup, MeshInfo) == 0xc0);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveParticleMeshGroup, WorldTransform) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveParticleMeshGroup, BlendOp) == 0xf4);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveParticleMeshGroup, BlendMode) == 0xf8);

#endif // FABLE_ENGINE_CENGINEINTERNALPRIMITIVEPARTICLEMESHGROUP_H
