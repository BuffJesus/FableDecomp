#ifndef FABLE_ENGINE_CCREATUREACTION_GETINBED_H
#define FABLE_ENGINE_CCREATUREACTION_GETINBED_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_GetInBed = 0xcc.
...
#pragma pack(push, 1)
struct CCreatureAction_GetInBed {
    ...
    unsigned char    PBed[0x8];                              // +0xb4 CIntelligentPointer<CThing>
    CCharStringData* AnimGroup_PStringData;                  // +0xbc CCharString::PStringData
    CCharStringData* SleepAnimName_PStringData;              // +0xc0 CCharString::PStringData
    long             BedGetInAnim;                           // +0xc4
    long             BedSleepAnim;                           // +0xc8
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_GetInBed) == 0xcc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetInBed, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetInBed, PBed) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetInBed, AnimGroup_PStringData) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetInBed, SleepAnimName_PStringData) == 0xc0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetInBed, BedGetInAnim) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetInBed, BedSleepAnim) == 0xc8);

#endif // FABLE_ENGINE_CCREATUREACTION_GETINBED_H
