...
struct CCreatureAction_GetInBed {
    ...
    unsigned char AnimGroup[0x4];                            // +0xbc CCharString
    unsigned char SleepAnimName[0x4];                        // +0xc0 CCharString
...
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetInBed, AnimGroup) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetInBed, SleepAnimName) == 0xc0);
