#ifndef FABLE_ENGINE_CCREATUREACTION_PLAYERINTERACTIONGREET_H
#define FABLE_ENGINE_CCREATUREACTION_PLAYERINTERACTIONGREET_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_PlayerInteractionGreet = 0xbc.
...
#pragma pack(push, 1)
struct CCreatureAction_PlayerInteractionGreet {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_PlayerInteractionGreet) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayerInteractionGreet, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayerInteractionGreet, PTarget) == 0xb4);

#endif // FABLE_ENGINE_CCREATUREACTION_PLAYERINTERACTIONGREET_H
