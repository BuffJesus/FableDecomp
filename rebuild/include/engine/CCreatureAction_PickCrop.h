#ifndef FABLE_ENGINE_CCREATUREACTION_PICKCROP_H
#define FABLE_ENGINE_CCREATUREACTION_PICKCROP_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_PickCrop = 0xbc.
...
struct CCreatureAction_PickCrop {
    ...
    long          sub;                                       // +0xa8 retail-only long (previous header)
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_PickCrop) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PickCrop, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PickCrop, sub) == 0xa8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PickCrop, PObjectToUse) == 0xb4);

#endif // FABLE_ENGINE_CCREATUREACTION_PICKCROP_H
