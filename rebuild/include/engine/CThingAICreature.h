...
struct CThingAICreature {
    ...
    unsigned char RelationshipsInit[0x8];                    // +0x188 CCountedPointer<CThingAICreature::CRelationshipsInit>
    ...
    unsigned char OverridingBrainName[0x4];                  // +0x1b8 CCharString
    ...
    unsigned char PCurrentBrainOutput[0x8];                  // +0x1d0 CCountedPointer<CBrainOutput>
    unsigned char PBrain[0x8];                               // +0x1d8 CCountedPointer<CAIBrain>
...
FABLE_STATIC_ASSERT(offsetof(CThingAICreature, RelationshipsInit) == 0x188);
...
FABLE_STATIC_ASSERT(offsetof(CThingAICreature, OverridingBrainName) == 0x1b8);
...
FABLE_STATIC_ASSERT(offsetof(CThingAICreature, PCurrentBrainOutput) == 0x1d0);
FABLE_STATIC_ASSERT(offsetof(CThingAICreature, PBrain) == 0x1d8);
