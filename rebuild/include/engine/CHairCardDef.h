#ifndef FABLE_ENGINE_CHAIRCARDDEF_H
#define FABLE_ENGINE_CHAIRCARDDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CHairCardDef = 0x2c.
...
struct CHairCardDef {
    ...
    long          HairObject;                                // +0x28
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CHairCardDef) == 0x2c);
FABLE_STATIC_ASSERT(offsetof(CHairCardDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CHairCardDef, HairObject) == 0x28);

#endif // FABLE_ENGINE_CHAIRCARDDEF_H
