#ifndef FABLE_ENGINE_CCREATUREACTION_SCORPIONTAILPLUNGE_H
#define FABLE_ENGINE_CCREATUREACTION_SCORPIONTAILPLUNGE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ScorpionTailPlunge = 0x138.
...
#pragma pack(push, 1)
struct CCreatureAction_ScorpionTailPlunge {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ScorpionTailPlunge) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionTailPlunge, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionTailPlunge, TargetPos_X) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionTailPlunge, TargetPos_Y) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionTailPlunge, TargetPos_Z) == 0x134);

#endif // FABLE_ENGINE_CCREATUREACTION_SCORPIONTAILPLUNGE_H
