#ifndef FABLE_ENGINE_CCREATUREACTION_CASTWILLRECLAIMUNDEADFOLLOWER_H
#define FABLE_ENGINE_CCREATUREACTION_CASTWILLRECLAIMUNDEADFOLLOWER_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_CastWillReclaimUndeadFollower = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_CastWillReclaimUndeadFollower {
    ...
    unsigned char PUndeadFollower[0x8];                      // +0x12c CIntelligentPointer<CThingGameObject>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_CastWillReclaimUndeadFollower) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillReclaimUndeadFollower, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillReclaimUndeadFollower, PUndeadFollower) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_CASTWILLRECLAIMUNDEADFOLLOWER_H
