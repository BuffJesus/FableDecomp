#ifndef FABLE_ENGINE_CCREATUREACTION_CASTPHYSICALSHIELDSPELL_H
#define FABLE_ENGINE_CCREATUREACTION_CASTPHYSICALSHIELDSPELL_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_CastPhysicalShieldSpell = 0x13c.
...
#pragma pack(push, 1)
struct CCreatureAction_CastPhysicalShieldSpell {
    ...
    bool          ImmediateCast;                             // +0x12c
    bool          OneAnimCast;                               // +0x12d
    unsigned char _pad_0x12e[0x2];                           // +0x12e
    long          LevelToCast;                               // +0x130
    long          TimeLimit;                                 // +0x134
    float         ShieldHealth;                              // +0x138
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_CastPhysicalShieldSpell) == 0x13c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastPhysicalShieldSpell, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastPhysicalShieldSpell, ImmediateCast) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastPhysicalShieldSpell, OneAnimCast) == 0x12d);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastPhysicalShieldSpell, LevelToCast) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastPhysicalShieldSpell, TimeLimit) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastPhysicalShieldSpell, ShieldHealth) == 0x138);

#endif // FABLE_ENGINE_CCREATUREACTION_CASTPHYSICALSHIELDSPELL_H
