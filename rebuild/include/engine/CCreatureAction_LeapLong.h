#ifndef FABLE_ENGINE_CCREATUREACTION_LEAPLONG_H
#define FABLE_ENGINE_CCREATUREACTION_LEAPLONG_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_LeapLong = 0x130.
...
#pragma pack(push, 1)
struct CCreatureAction_LeapLong {
    ...
    unsigned char b114;                                      // +0x114 retail-only (CCreatureActionLeapLong_IsToEvadeAllHits_008b86c0.cpp)
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_LeapLong) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_LeapLong, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_LeapLong, b114) == 0x114);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_LeapLong, Landed) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_LEAPLONG_H
