#ifndef FABLE_ENGINE_CEXPRESSIONSUBDEF_H
#define FABLE_ENGINE_CEXPRESSIONSUBDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CExpressionSubDef = 0x2c.
...
struct CExpressionSubDef {
    ...
    long          ExpressionDef;                             // +0x28
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CExpressionSubDef) == 0x2c);
FABLE_STATIC_ASSERT(offsetof(CExpressionSubDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CExpressionSubDef, ExpressionDef) == 0x28);

#endif // FABLE_ENGINE_CEXPRESSIONSUBDEF_H
