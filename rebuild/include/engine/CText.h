...
struct CText {
    ...
    unsigned char flags;                                     // +0x15c retail-only (CText_GetAlignment_00661e80.cpp)
    ...
    unsigned char Value[0x4];                                // +0x18c CWideString
    unsigned char PFont[0x8];                                // +0x190 CCountedPointer<CFontBank>
    ...
    unsigned char Window[0x10];                              // +0x1a8 C2DBoxF
...
FABLE_STATIC_ASSERT(offsetof(CText, Value) == 0x18c);
FABLE_STATIC_ASSERT(offsetof(CText, PFont) == 0x190);
FABLE_STATIC_ASSERT(offsetof(CText, Handle) == 0x198);
FABLE_STATIC_ASSERT(offsetof(CText, HandleDropShadowBottomRight) == 0x1a0);
FABLE_STATIC_ASSERT(offsetof(CText, Window) == 0x1a8);
