#ifndef FABLE_ENGINE_CTEXT_H
#define FABLE_ENGINE_CTEXT_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CText = 0x1bc.
...
struct CText {
    ...
    CWideStringData* Value_PStringData;                      // +0x18c CWideString::PStringData
    CFontBank*       PFont_Data;                             // +0x190 CCountedPointer<CFontBank>::Data
    CCPPointerInfo*  PFont_Info;                             // +0x194 CCountedPointer<CFontBank>::Info
    unsigned char    Handle[0x8];                            // +0x198 CEnginePrimitiveHandle
    unsigned char    HandleDropShadowBottomRight[0x8];       // +0x1a0 CEnginePrimitiveHandle
    float            Window_TLX;                             // +0x1a8 C2DBoxF::TLX
    float            Window_TLY;                             // +0x1ac C2DBoxF::TLY
    float            Window_BRX;                             // +0x1b0 C2DBoxF::BRX
    float            Window_BRY;                             // +0x1b4 C2DBoxF::BRY
    bool             ScaleText;                              // +0x1b8
    bool             Unavailable;                            // +0x1b9
    unsigned char    NoRenderNextFrame;                      // +0x1ba
    unsigned char    _pad_0x1bb[0x1];                        // +0x1bb
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CText) == 0x1bc);
FABLE_STATIC_ASSERT(offsetof(CText, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CText, flags) == 0x15c);
FABLE_STATIC_ASSERT(offsetof(CText, Value_PStringData) == 0x18c);
FABLE_STATIC_ASSERT(offsetof(CText, PFont_Data) == 0x190);
FABLE_STATIC_ASSERT(offsetof(CText, PFont_Info) == 0x194);
FABLE_STATIC_ASSERT(offsetof(CText, Handle) == 0x198);
FABLE_STATIC_ASSERT(offsetof(CText, HandleDropShadowBottomRight) == 0x1a0);
FABLE_STATIC_ASSERT(offsetof(CText, Window_TLX) == 0x1a8);
FABLE_STATIC_ASSERT(offsetof(CText, Window_TLY) == 0x1ac);
FABLE_STATIC_ASSERT(offsetof(CText, Window_BRX) == 0x1b0);
FABLE_STATIC_ASSERT(offsetof(CText, Window_BRY) == 0x1b4);
FABLE_STATIC_ASSERT(offsetof(CText, ScaleText) == 0x1b8);
FABLE_STATIC_ASSERT(offsetof(CText, Unavailable) == 0x1b9);
FABLE_STATIC_ASSERT(offsetof(CText, NoRenderNextFrame) == 0x1ba);

#endif // FABLE_ENGINE_CTEXT_H
