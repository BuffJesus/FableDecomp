#ifndef FABLE_ENGINE_CCREATUREACTION_DRAGONFIREBLASTBASE_H
#define FABLE_ENGINE_CCREATUREACTION_DRAGONFIREBLASTBASE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_DragonFireBlastBase = 0x13c.
...
#pragma pack(push, 1)
struct CCreatureAction_DragonFireBlastBase {
    ...
    unsigned char Line1[0x8];                                // +0x134 CEnginePrimitiveHandle
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_DragonFireBlastBase) == 0x13c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonFireBlastBase, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonFireBlastBase, PShot) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonFireBlastBase, Line1) == 0x134);

#endif // FABLE_ENGINE_CCREATUREACTION_DRAGONFIREBLASTBASE_H
