#ifndef FABLE_ENGINE_CCREATUREACTION_THROWGAMEOBJECT_H
#define FABLE_ENGINE_CCREATUREACTION_THROWGAMEOBJECT_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ThrowGameObject = 0xc0.
...
#pragma pack(push, 1)
struct CCreatureAction_ThrowGameObject {
    ...
    float         Force_X;                                   // +0xb4 C3DVector::X
    float         Force_Y;                                   // +0xb8 C3DVector::Y
    float         Force_Z;                                   // +0xbc C3DVector::Z
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ThrowGameObject) == 0xc0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ThrowGameObject, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ThrowGameObject, Force_X) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ThrowGameObject, Force_Y) == 0xb8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ThrowGameObject, Force_Z) == 0xbc);

#endif // FABLE_ENGINE_CCREATUREACTION_THROWGAMEOBJECT_H
