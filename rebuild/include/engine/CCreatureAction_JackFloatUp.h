#ifndef FABLE_ENGINE_CCREATUREACTION_JACKFLOATUP_H
#define FABLE_ENGINE_CCREATUREACTION_JACKFLOATUP_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_JackFloatUp = 0x13c.
...
#pragma pack(push, 1)
struct CCreatureAction_JackFloatUp {
    ...
    float         FloatHeight;                               // +0x12c
    float         FloatSpeed;                                // +0x130
    bool          Moving;                                    // +0x134
    unsigned char _pad_0x135[0x3];                           // +0x135
    float         StartHeight;                               // +0x138
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_JackFloatUp) == 0x13c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_JackFloatUp, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_JackFloatUp, FloatHeight) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_JackFloatUp, FloatSpeed) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_JackFloatUp, Moving) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_JackFloatUp, StartHeight) == 0x138);

#endif // FABLE_ENGINE_CCREATUREACTION_JACKFLOATUP_H
