#ifndef FABLE_ENGINE_CCREATUREACTION_DRINK_H
#define FABLE_ENGINE_CCREATUREACTION_DRINK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_Drink = 0xc4.
...
struct CCreatureAction_Drink {
    ...
    unsigned char PThingToDrink[0x8];                        // +0xb4 CIntelligentPointer<CThing>
    unsigned char PThingPreviouslyCarrying[0x8];             // +0xbc CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_Drink) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_Drink, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_Drink, PThingToDrink) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_Drink, PThingPreviouslyCarrying) == 0xbc);

#endif // FABLE_ENGINE_CCREATUREACTION_DRINK_H
