#ifndef FABLE_ENGINE_CCOMBATACTION_WILLSHIELDINTO_H
#define FABLE_ENGINE_CCOMBATACTION_WILLSHIELDINTO_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCombatAction_WillShieldInto = 0x134.
...
#pragma pack(push, 1)
struct CCombatAction_WillShieldInto {
    ...
    float         ShieldUpTime;                              // +0x12c
    float         ShieldHealth;                              // +0x130
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCombatAction_WillShieldInto) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_WillShieldInto, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_WillShieldInto, ShieldUpTime) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_WillShieldInto, ShieldHealth) == 0x130);

#endif // FABLE_ENGINE_CCOMBATACTION_WILLSHIELDINTO_H
