#ifndef FABLE_ENGINE_CCREATUREACTION_UNDEADRISEUP_H
#define FABLE_ENGINE_CCREATUREACTION_UNDEADRISEUP_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_UndeadRiseUp = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_UndeadRiseUp {
    ...
    unsigned char f;                                         // +0x118 retail-only (CCreatureActionUndeadRiseUp_IsToEvadeAllHits_0074dce0.cpp)
    ...
    bool          StillUnderground;                          // +0x130
    unsigned char _pad_0x131[0x3];                           // +0x131
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_UndeadRiseUp) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UndeadRiseUp, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UndeadRiseUp, f) == 0x118);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UndeadRiseUp, StillUnderground) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_UNDEADRISEUP_H
