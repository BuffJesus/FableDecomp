#ifndef FABLE_ENGINE_CTABLE_H
#define FABLE_ENGINE_CTABLE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CTable = 0x1a4.
...
struct CTable {
    ...
    unsigned char Sprites[0x10];                             // +0x18c map<NUISystem::ETableSprites,CCountedPointer<NUISystem::CComponent>,std::less<NUISystem::ETableSprites>,std::allocator<std::pair<NUISystem::ETableSprites_const_,CCountedPointer<NUISystem::CComponent>_>_>_>
    void*         PHorizontalSeparations;                    // +0x19c vector<unsigned_long,std::allocator<unsigned_long>_> *
    void*         PVerticalSeparations;                      // +0x1a0 vector<unsigned_long,std::allocator<unsigned_long>_> *
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CTable) == 0x1a4);
FABLE_STATIC_ASSERT(offsetof(CTable, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CTable, Sprites) == 0x18c);
FABLE_STATIC_ASSERT(offsetof(CTable, PHorizontalSeparations) == 0x19c);
FABLE_STATIC_ASSERT(offsetof(CTable, PVerticalSeparations) == 0x1a0);

#endif // FABLE_ENGINE_CTABLE_H
