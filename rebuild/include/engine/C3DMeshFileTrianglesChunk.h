#ifndef FABLE_ENGINE_C3DMESHFILETRIANGLESCHUNK_H
#define FABLE_ENGINE_C3DMESHFILETRIANGLESCHUNK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof C3DMeshFileTrianglesChunk = 0x44.
...
struct C3DMeshFileTrianglesChunk {
    ...
    unsigned char TriangleList[0x10];                        // +0x34 CArray<C3DTriangle2>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(C3DMeshFileTrianglesChunk) == 0x44);
FABLE_STATIC_ASSERT(offsetof(C3DMeshFileTrianglesChunk, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(C3DMeshFileTrianglesChunk, TriangleList) == 0x34);

#endif // FABLE_ENGINE_C3DMESHFILETRIANGLESCHUNK_H
