#ifndef FABLE_ENGINE_CCREATUREACTION_DRAGONSWOOP_H
#define FABLE_ENGINE_CCREATUREACTION_DRAGONSWOOP_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_DragonSwoop = 0x150.
...
#pragma pack(push, 1)
struct CCreatureAction_DragonSwoop {
    ...
    unsigned char SwoopPoints[0x24];                         // +0x12c C3DVector[3]
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_DragonSwoop) == 0x150);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonSwoop, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonSwoop, SwoopPoints) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_DRAGONSWOOP_H
