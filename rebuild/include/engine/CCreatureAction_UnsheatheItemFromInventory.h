#ifndef FABLE_ENGINE_CCREATUREACTION_UNSHEATHEITEMFROMINVENTORY_H
#define FABLE_ENGINE_CCREATUREACTION_UNSHEATHEITEMFROMINVENTORY_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_UnsheatheItemFromInventory = 0xc4.
...
#pragma pack(push, 1)
struct CCreatureAction_UnsheatheItemFromInventory {
    ...
    unsigned char        PUnsheatheItem[0x8];                // +0xb4 CIntelligentPointer<CThing>
    CCreatureActionBase* PFollowUpAction_Data;               // +0xbc CCountedPointer<CCreatureActionBase>::Data
    CCPPointerInfo*      PFollowUpAction_Info;               // +0xc0 CCountedPointer<CCreatureActionBase>::Info
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_UnsheatheItemFromInventory) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheItemFromInventory, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheItemFromInventory, PUnsheatheItem) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheItemFromInventory, PFollowUpAction_Data) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheItemFromInventory, PFollowUpAction_Info) == 0xc0);

#endif // FABLE_ENGINE_CCREATUREACTION_UNSHEATHEITEMFROMINVENTORY_H
