#ifndef FABLE_ENGINE_CCREATUREACTION_BATTLECHARGEMISS_H
#define FABLE_ENGINE_CCREATUREACTION_BATTLECHARGEMISS_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_BattleChargeMiss = 0x13c.
...
#pragma pack(push, 1)
struct CCreatureAction_BattleChargeMiss {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_BattleChargeMiss) == 0x13c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BattleChargeMiss, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BattleChargeMiss, Left) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BattleChargeMiss, Right) == 0x134);

#endif // FABLE_ENGINE_CCREATUREACTION_BATTLECHARGEMISS_H
