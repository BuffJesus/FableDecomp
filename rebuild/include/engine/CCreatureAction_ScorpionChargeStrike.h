#ifndef FABLE_ENGINE_CCREATUREACTION_SCORPIONCHARGESTRIKE_H
#define FABLE_ENGINE_CCREATUREACTION_SCORPIONCHARGESTRIKE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ScorpionChargeStrike = 0x13c.
...
#pragma pack(push, 1)
struct CCreatureAction_ScorpionChargeStrike {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ScorpionChargeStrike) == 0x13c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionChargeStrike, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionChargeStrike, ChargeDistance) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionChargeStrike, StartPos_X) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionChargeStrike, StartPos_Y) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionChargeStrike, StartPos_Z) == 0x138);

#endif // FABLE_ENGINE_CCREATUREACTION_SCORPIONCHARGESTRIKE_H
