...
struct CDrawMiniMap {
    ...
    unsigned char f_18;                                      // +0x18 retail-only unsigned char (previous header)
    ...
    long          disp;                                      // +0x28 retail-only CMiniMapDisplay (previous header)
...
FABLE_STATIC_ASSERT(offsetof(CDrawMiniMap, disp) == 0x28);
