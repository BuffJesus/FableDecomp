...
struct CDrawMiniMap {
    ...
    long          f_c;                                       // +0x0c retail-only long (previous header)
    unsigned char _pad_0x10[0x4];                            // +0x10
    unsigned char _pad_0x14[0x4];                            // +0x14
    unsigned char f_18;                                      // +0x18 retail-only unsigned char (CDrawMiniMap_ClearPrimitivesIfNecessary_00643de5.cpp)
    ...
    long          sub;                                       // +0x28 retail-only SubObj (CDrawMiniMap_ClearPrimitivesIfNecessary_00643de5.cpp)
...
FABLE_STATIC_ASSERT(offsetof(CDrawMiniMap, f_18) == 0x18);
FABLE_STATIC_ASSERT(offsetof(CDrawMiniMap, sub) == 0x28);
