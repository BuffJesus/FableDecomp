#ifndef FABLE_ENGINE_CCOMBATACTION_KICKTHINGONGROUND_H
#define FABLE_ENGINE_CCOMBATACTION_KICKTHINGONGROUND_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCombatAction_KickThingOnGround = 0x148.
...
#pragma pack(push, 1)
struct CCombatAction_KickThingOnGround {
