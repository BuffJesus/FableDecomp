#ifndef FABLE_ENGINE_CCREATUREACTION_FIREMISSILETEST_H
#define FABLE_ENGINE_CCREATUREACTION_FIREMISSILETEST_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_FireMissileTest = 0xc0.
...
#pragma pack(push, 1)
struct CCreatureAction_FireMissileTest {
    ...
    long          GlobalIndex;                               // +0xbc
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_FireMissileTest) == 0xc0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_FireMissileTest, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_FireMissileTest, PTarget) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_FireMissileTest, GlobalIndex) == 0xbc);

#endif // FABLE_ENGINE_CCREATUREACTION_FIREMISSILETEST_H
