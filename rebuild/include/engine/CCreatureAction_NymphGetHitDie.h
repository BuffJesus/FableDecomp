#ifndef FABLE_ENGINE_CCREATUREACTION_NYMPHGETHITDIE_H
#define FABLE_ENGINE_CCREATUREACTION_NYMPHGETHITDIE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_NymphGetHitDie = 0x164.
...
#pragma pack(push, 1)
struct CCreatureAction_NymphGetHitDie {
    ...
    float         HeightOnInit;                              // +0x160
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_NymphGetHitDie) == 0x164);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_NymphGetHitDie, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_NymphGetHitDie, HeightOnInit) == 0x160);

#endif // FABLE_ENGINE_CCREATUREACTION_NYMPHGETHITDIE_H
