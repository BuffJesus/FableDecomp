#ifndef FABLE_ENGINE_CCREATUREACTION_TROLLPROJECTILEATTACK_H
#define FABLE_ENGINE_CCREATUREACTION_TROLLPROJECTILEATTACK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_TrollProjectileAttack = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_TrollProjectileAttack {
    ...
    bool             OverriddenAnim;                         // +0x12c
    unsigned char    _pad_0x12d[0x3];                        // +0x12d
    CCharStringData* AnimName_PStringData;                   // +0x130 CCharString::PStringData
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_TrollProjectileAttack) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_TrollProjectileAttack, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_TrollProjectileAttack, OverriddenAnim) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_TrollProjectileAttack, AnimName_PStringData) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_TROLLPROJECTILEATTACK_H
