#ifndef FABLE_ENGINE_CCREATUREACTION_CASTWILLLIGHTNINGSPELL_H
#define FABLE_ENGINE_CCREATUREACTION_CASTWILLLIGHTNINGSPELL_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_CastWillLightningSpell = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_CastWillLightningSpell {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_CastWillLightningSpell) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillLightningSpell, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillLightningSpell, Level) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillLightningSpell, Secs) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_CASTWILLLIGHTNINGSPELL_H
