#ifndef FABLE_ENGINE_CTCSHOTDEFINITIONPROJECTILE_H
#define FABLE_ENGINE_CTCSHOTDEFINITIONPROJECTILE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CTCShotDefinitionProjectile = 0xa8.
...
struct CTCShotDefinitionProjectile {
    ...
    unsigned char Line1[0x8];                                // +0xa0 CEnginePrimitiveHandle
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CTCShotDefinitionProjectile) == 0xa8);
FABLE_STATIC_ASSERT(offsetof(CTCShotDefinitionProjectile, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CTCShotDefinitionProjectile, m4) == 0x4);
FABLE_STATIC_ASSERT(offsetof(CTCShotDefinitionProjectile, Line1) == 0xa0);

#endif // FABLE_ENGINE_CTCSHOTDEFINITIONPROJECTILE_H
