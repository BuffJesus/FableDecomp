#ifndef FABLE_ENGINE_CCREATUREACTION_CASTSTRENGTHMULTISTRIKEPROPER_H
#define FABLE_ENGINE_CCREATUREACTION_CASTSTRENGTHMULTISTRIKEPROPER_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_CastStrengthMultiStrikeProper = 0x130.
...
#pragma pack(push, 1)
struct CCreatureAction_CastStrengthMultiStrikeProper {
    ...
    long          SpellLevel;                                // +0x12c
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_CastStrengthMultiStrikeProper) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastStrengthMultiStrikeProper, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastStrengthMultiStrikeProper, SpellLevel) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_CASTSTRENGTHMULTISTRIKEPROPER_H
