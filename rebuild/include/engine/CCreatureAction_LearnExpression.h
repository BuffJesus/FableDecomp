#ifndef FABLE_ENGINE_CCREATUREACTION_LEARNEXPRESSION_H
#define FABLE_ENGINE_CCREATUREACTION_LEARNEXPRESSION_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_LearnExpression = 0xc4.
...
#pragma pack(push, 1)
struct CCreatureAction_LearnExpression {
    ...
    unsigned char PPlayerCreature[0x8];                      // +0xb4 CIntelligentPointer<CThingPlayerCreature>
    unsigned char PLearnFromThing[0x8];                      // +0xbc CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_LearnExpression) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_LearnExpression, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_LearnExpression, PPlayerCreature) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_LearnExpression, PLearnFromThing) == 0xbc);

#endif // FABLE_ENGINE_CCREATUREACTION_LEARNEXPRESSION_H
