#ifndef FABLE_ENGINE_CSPRITE_H
#define FABLE_ENGINE_CSPRITE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CSprite = 0x1b4.
...
struct CSprite {
    ...
    unsigned char   Handle[0x8];                             // +0x18c CEnginePrimitiveHandle
    float           Angle;                                   // +0x194
    unsigned long   Width;                                   // +0x198
    unsigned long   Height;                                  // +0x19c
    unsigned char   NoRenderNextFrame;                       // +0x1a0
    unsigned char   _pad_0x1a1[0x3];                         // +0x1a1
    unsigned char   Sprite2DFlag[0x4];                       // +0x1a4 EEngineSprite2DFlag
    unsigned long   GraphicIndex;                            // +0x1a8
    CTexture*       PTexture_Data;                           // +0x1ac CCountedPointer<CTexture>::Data
    CCPPointerInfo* PTexture_Info;                           // +0x1b0 CCountedPointer<CTexture>::Info
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CSprite) == 0x1b4);
FABLE_STATIC_ASSERT(offsetof(CSprite, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CSprite, Handle) == 0x18c);
FABLE_STATIC_ASSERT(offsetof(CSprite, Angle) == 0x194);
FABLE_STATIC_ASSERT(offsetof(CSprite, Width) == 0x198);
FABLE_STATIC_ASSERT(offsetof(CSprite, Height) == 0x19c);
FABLE_STATIC_ASSERT(offsetof(CSprite, NoRenderNextFrame) == 0x1a0);
FABLE_STATIC_ASSERT(offsetof(CSprite, Sprite2DFlag) == 0x1a4);
FABLE_STATIC_ASSERT(offsetof(CSprite, GraphicIndex) == 0x1a8);
FABLE_STATIC_ASSERT(offsetof(CSprite, PTexture_Data) == 0x1ac);
FABLE_STATIC_ASSERT(offsetof(CSprite, PTexture_Info) == 0x1b0);

#endif // FABLE_ENGINE_CSPRITE_H
