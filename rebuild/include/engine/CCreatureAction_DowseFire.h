#ifndef FABLE_ENGINE_CCREATUREACTION_DOWSEFIRE_H
#define FABLE_ENGINE_CCREATUREACTION_DOWSEFIRE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_DowseFire = 0xc8.
...
#pragma pack(push, 1)
struct CCreatureAction_DowseFire {
    ...
    unsigned char PAICreature[0x8];                          // +0xb4 CIntelligentPointer<CThingAICreature>
    unsigned char PBuilding[0x8];                            // +0xbc CIntelligentPointer<CThingBuilding>
    unsigned long FireNumber;                                // +0xc4
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_DowseFire) == 0xc8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DowseFire, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DowseFire, PAICreature) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DowseFire, PBuilding) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DowseFire, FireNumber) == 0xc4);

#endif // FABLE_ENGINE_CCREATUREACTION_DOWSEFIRE_H
