#ifndef FABLE_ENGINE_CHOVERABLE_H
#define FABLE_ENGINE_CHOVERABLE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CHoverable = 0x19c.
...
struct CHoverable {
    ...
    long          StateBeforeHovered;                        // +0x18c
    bool          WasHovered;                                // +0x190
    unsigned char _pad_0x191[0x3];                           // +0x191
    void*         PActionsOnHovered;                         // +0x194 list<CCountedPointer<NUISystem::CAction>,std::allocator<CCountedPointer<NUISystem::CAction>_>_> *
    void*         PActionsOnUnhovered;                       // +0x198 list<CCountedPointer<NUISystem::CAction>,std::allocator<CCountedPointer<NUISystem::CAction>_>_> *
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CHoverable) == 0x19c);
FABLE_STATIC_ASSERT(offsetof(CHoverable, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CHoverable, StateBeforeHovered) == 0x18c);
FABLE_STATIC_ASSERT(offsetof(CHoverable, WasHovered) == 0x190);
FABLE_STATIC_ASSERT(offsetof(CHoverable, PActionsOnHovered) == 0x194);
FABLE_STATIC_ASSERT(offsetof(CHoverable, PActionsOnUnhovered) == 0x198);

#endif // FABLE_ENGINE_CHOVERABLE_H
