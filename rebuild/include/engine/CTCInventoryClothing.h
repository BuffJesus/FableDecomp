#ifndef FABLE_ENGINE_CTCINVENTORYCLOTHING_H
#define FABLE_ENGINE_CTCINVENTORYCLOTHING_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CTCInventoryClothing = 0x198.
...
struct CTCInventoryClothing {
    ...
    unsigned char ClothingMenuEntries[0x10];                 // +0x14c vector<std::pair<EClothingSuitPart,NUISystem::CComponent_*>,std::allocator<std::pair<EClothingSuitPart,NUISystem::CComponent_*>_>_>
    unsigned char CurrentClothingSelected[0x10];             // +0x15c map<EClothingSuitPart,long,std::less<EClothingSuitPart>,std::allocator<std::pair<EClothingSuitPart_const_,long>_>_>
    unsigned char MorphPrimitiveHandles[0x10];               // +0x16c map<long,CEnginePrimitiveHandle,std::less<long>,std::allocator<std::pair<long_const_,CEnginePrimitiveHandle>_>_>
    CThing*       PMannequin;                                // +0x17c
    bool          UseMannequin;                              // +0x180
    bool          LoadedFromSaveGame;                        // +0x181
    unsigned char _pad_0x182[0x2];                           // +0x182
    unsigned char ClothingItemMap[0x10];                     // +0x184 map<NUISystem::CComponent_*,long,std::less<NUISystem::CComponent_*>,std::allocator<std::pair<NUISystem::CComponent_*_const,long>_>_>
    CComponent*   ClothingList;                              // +0x194
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CTCInventoryClothing) == 0x198);
FABLE_STATIC_ASSERT(offsetof(CTCInventoryClothing, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CTCInventoryClothing, ClothingMenuEntries) == 0x14c);
FABLE_STATIC_ASSERT(offsetof(CTCInventoryClothing, CurrentClothingSelected) == 0x15c);
FABLE_STATIC_ASSERT(offsetof(CTCInventoryClothing, MorphPrimitiveHandles) == 0x16c);
FABLE_STATIC_ASSERT(offsetof(CTCInventoryClothing, PMannequin) == 0x17c);
FABLE_STATIC_ASSERT(offsetof(CTCInventoryClothing, UseMannequin) == 0x180);
FABLE_STATIC_ASSERT(offsetof(CTCInventoryClothing, LoadedFromSaveGame) == 0x181);
FABLE_STATIC_ASSERT(offsetof(CTCInventoryClothing, ClothingItemMap) == 0x184);
FABLE_STATIC_ASSERT(offsetof(CTCInventoryClothing, ClothingList) == 0x194);

#endif // FABLE_ENGINE_CTCINVENTORYCLOTHING_H
