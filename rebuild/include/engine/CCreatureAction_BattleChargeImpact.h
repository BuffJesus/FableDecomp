#ifndef FABLE_ENGINE_CCREATUREACTION_BATTLECHARGEIMPACT_H
#define FABLE_ENGINE_CCREATUREACTION_BATTLECHARGEIMPACT_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_BattleChargeImpact = 0x13c.
...
#pragma pack(push, 1)
struct CCreatureAction_BattleChargeImpact {
    ...
    unsigned char Left[0x8];                                 // +0x12c CIntelligentPointer<CThing>
    unsigned char Right[0x8];                                // +0x134 CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_BattleChargeImpact) == 0x13c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BattleChargeImpact, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BattleChargeImpact, Left) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BattleChargeImpact, Right) == 0x134);

#endif // FABLE_ENGINE_CCREATUREACTION_BATTLECHARGEIMPACT_H
