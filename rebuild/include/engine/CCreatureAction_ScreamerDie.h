#ifndef FABLE_ENGINE_CCREATUREACTION_SCREAMERDIE_H
#define FABLE_ENGINE_CCREATUREACTION_SCREAMERDIE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ScreamerDie = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_ScreamerDie {
    ...
    unsigned char PDieEffect[0x8];                           // +0x12c CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ScreamerDie) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScreamerDie, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScreamerDie, PDieEffect) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_SCREAMERDIE_H
