#ifndef FABLE_ENGINE_CCREATUREACTION_CASTWILLFIREBALLSPELL_H
#define FABLE_ENGINE_CCREATUREACTION_CASTWILLFIREBALLSPELL_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_CastWillFireballSpell = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_CastWillFireballSpell {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_CastWillFireballSpell) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillFireballSpell, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillFireballSpell, ImmediateCast) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillFireballSpell, OneAnimCast) == 0x12d);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillFireballSpell, LevelToCast) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_CASTWILLFIREBALLSPELL_H
