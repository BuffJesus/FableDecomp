#ifndef FABLE_ENGINE_CCREATUREACTION_DRAGONFLIGHT_H
#define FABLE_ENGINE_CCREATUREACTION_DRAGONFLIGHT_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_DragonFlight = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_DragonFlight {
    ...
    unsigned char f;                                         // +0x114 retail-only (CCreatureActionDragonFlight_IsToFaceTarget_008f55f0.cpp)
    ...
    float         TurnRate;                                  // +0x130
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_DragonFlight) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonFlight, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonFlight, f) == 0x114);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonFlight, FaceTarget) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonFlight, TurnRate) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_DRAGONFLIGHT_H
