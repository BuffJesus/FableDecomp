...
struct CCreatureAction_DragonTakeOffIntoFlying {
    ...
    unsigned char Dest[0xc];                                 // +0x12c C3DVector
    unsigned char StartPos[0xc];                             // +0x138 C3DVector
    unsigned char PreviousPoint[0xc];                        // +0x144 C3DVector
    ...
    unsigned char PEndAction[0x8];                           // +0x164 CCountedPointer<CCreatureActionBase>
};
#pragma pack(pop)
...
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, Dest) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, StartPos) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, PreviousPoint) == 0x144);
...
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, PEndAction) == 0x164);
