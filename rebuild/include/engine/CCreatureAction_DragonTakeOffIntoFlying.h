#ifndef FABLE_ENGINE_CCREATUREACTION_DRAGONTAKEOFFINTOFLYING_H
#define FABLE_ENGINE_CCREATUREACTION_DRAGONTAKEOFFINTOFLYING_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_DragonTakeOffIntoFlying = 0x16c.
...
#pragma pack(push, 1)
struct CCreatureAction_DragonTakeOffIntoFlying {
    ...
    float                Dest_X;                             // +0x12c C3DVector::X
    float                Dest_Y;                             // +0x130 C3DVector::Y
    float                Dest_Z;                             // +0x134 C3DVector::Z
    float                StartPos_X;                         // +0x138 C3DVector::X
    float                StartPos_Y;                         // +0x13c C3DVector::Y
    float                StartPos_Z;                         // +0x140 C3DVector::Z
    float                PreviousPoint_X;                    // +0x144 C3DVector::X
    float                PreviousPoint_Y;                    // +0x148 C3DVector::Y
    float                PreviousPoint_Z;                    // +0x14c C3DVector::Z
    unsigned char        MovementPoints[0x10];               // +0x150 vector<C3DVector,std::allocator<C3DVector>_>
    bool                 UsePreviousPoint;                   // +0x160
    unsigned char        _pad_0x161[0x3];                    // +0x161
    CCreatureActionBase* PEndAction_Data;                    // +0x164 CCountedPointer<CCreatureActionBase>::Data
    CCPPointerInfo*      PEndAction_Info;                    // +0x168 CCountedPointer<CCreatureActionBase>::Info
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_DragonTakeOffIntoFlying) == 0x16c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, Dest_X) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, Dest_Y) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, Dest_Z) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, StartPos_X) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, StartPos_Y) == 0x13c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, StartPos_Z) == 0x140);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, PreviousPoint_X) == 0x144);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, PreviousPoint_Y) == 0x148);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, PreviousPoint_Z) == 0x14c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, MovementPoints) == 0x150);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, UsePreviousPoint) == 0x160);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, PEndAction_Data) == 0x164);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DragonTakeOffIntoFlying, PEndAction_Info) == 0x168);

#endif // FABLE_ENGINE_CCREATUREACTION_DRAGONTAKEOFFINTOFLYING_H
