#ifndef FABLE_ENGINE_CCREATUREACTION_BANDITKINGATTACK_H
#define FABLE_ENGINE_CCREATUREACTION_BANDITKINGATTACK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_BanditKingAttack = 0x130.
...
#pragma pack(push, 1)
struct CCreatureAction_BanditKingAttack {
    ...
    unsigned char m_v;                                       // +0x114 retail-only (CCreatureActionBanditKingAttack_IsToFaceTarget_008c94b0.cpp)
    ...
    bool          ForceCauseRecoil;                          // +0x12d
    unsigned char _pad_0x12e[0x2];                           // +0x12e
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_BanditKingAttack) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingAttack, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingAttack, m_v) == 0x114);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingAttack, FaceTarget) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingAttack, ForceCauseRecoil) == 0x12d);

#endif // FABLE_ENGINE_CCREATUREACTION_BANDITKINGATTACK_H
