#ifndef FABLE_ENGINE_CMORPHINGSPRITE_H
#define FABLE_ENGINE_CMORPHINGSPRITE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CMorphingSprite = 0x1d8.
...
struct CMorphingSprite {
    ...
    long          RenderCount;                               // +0x1b4
    unsigned char Handles[0xc];                              // +0x1b8 list<CEnginePrimitiveHandle_*,std::allocator<CEnginePrimitiveHandle_*>_>
    unsigned char GraphicIndices[0x10];                      // +0x1c4 map<unsigned_long,unsigned_long,std::less<unsigned_long>,std::allocator<std::pair<unsigned_long_const_,unsigned_long>_>_>
    unsigned long SpriteGraphicIndex;                        // +0x1d4
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CMorphingSprite) == 0x1d8);
FABLE_STATIC_ASSERT(offsetof(CMorphingSprite, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CMorphingSprite, RenderCount) == 0x1b4);
FABLE_STATIC_ASSERT(offsetof(CMorphingSprite, Handles) == 0x1b8);
FABLE_STATIC_ASSERT(offsetof(CMorphingSprite, GraphicIndices) == 0x1c4);
FABLE_STATIC_ASSERT(offsetof(CMorphingSprite, SpriteGraphicIndex) == 0x1d4);

#endif // FABLE_ENGINE_CMORPHINGSPRITE_H
