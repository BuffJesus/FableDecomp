#ifndef FABLE_ENGINE_CENGINEVSCONSTANTLAYOUTREPEATEDMESH_H
#define FABLE_ENGINE_CENGINEVSCONSTANTLAYOUTREPEATEDMESH_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CEngineVSConstantLayoutRepeatedMesh = 0x180.
...
#pragma pack(push, 1)
struct CEngineVSConstantLayoutRepeatedMesh {
    ...
    unsigned char LightingResults[0xc];                      // +0x150 CShaderConstantRange
    unsigned char MainLightLightingResults[0xc];             // +0x15c CShaderConstantRange
    unsigned char ObjectMatricies[0xc];                      // +0x168 CShaderConstantRange
    unsigned char ObjectOffsets[0xc];                        // +0x174 CShaderConstantRange
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CEngineVSConstantLayoutRepeatedMesh) == 0x180);
FABLE_STATIC_ASSERT(offsetof(CEngineVSConstantLayoutRepeatedMesh, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CEngineVSConstantLayoutRepeatedMesh, LightingResults) == 0x150);
FABLE_STATIC_ASSERT(offsetof(CEngineVSConstantLayoutRepeatedMesh, MainLightLightingResults) == 0x15c);
FABLE_STATIC_ASSERT(offsetof(CEngineVSConstantLayoutRepeatedMesh, ObjectMatricies) == 0x168);
FABLE_STATIC_ASSERT(offsetof(CEngineVSConstantLayoutRepeatedMesh, ObjectOffsets) == 0x174);

#endif // FABLE_ENGINE_CENGINEVSCONSTANTLAYOUTREPEATEDMESH_H
