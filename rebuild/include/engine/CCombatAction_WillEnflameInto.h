#ifndef FABLE_ENGINE_CCOMBATACTION_WILLENFLAMEINTO_H
#define FABLE_ENGINE_CCOMBATACTION_WILLENFLAMEINTO_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCombatAction_WillEnflameInto = 0x130.
...
#pragma pack(push, 1)
struct CCombatAction_WillEnflameInto {
...
FABLE_STATIC_ASSERT(sizeof(CCombatAction_WillEnflameInto) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_WillEnflameInto, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_WillEnflameInto, Level) == 0x12c);

#endif // FABLE_ENGINE_CCOMBATACTION_WILLENFLAMEINTO_H
