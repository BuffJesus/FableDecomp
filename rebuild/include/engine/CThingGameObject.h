#ifndef FABLE_ENGINE_CTHINGGAMEOBJECT_H
#define FABLE_ENGINE_CTHINGGAMEOBJECT_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CThingGameObject = 0xe8.
...
struct CThingGameObject {
    ...
    unsigned char flags;                                     // +0xc8 retail-only (CThingGameObject_SetAddToComboMultiplierOnHit_008389a0.cpp)
    ...
    unsigned char PThingStandingOn[0x8];                     // +0xd8 CIntelligentPointer<CThing>
    unsigned char GiveHeroStatChangesOnBeingHitOverrideSet[0x8]; // +0xe0 bitfield group: uchar:1
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CThingGameObject) == 0xe8);
FABLE_STATIC_ASSERT(offsetof(CThingGameObject, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CThingGameObject, flags) == 0xc8);
FABLE_STATIC_ASSERT(offsetof(CThingGameObject, PThingStandingOn) == 0xd8);
FABLE_STATIC_ASSERT(offsetof(CThingGameObject, GiveHeroStatChangesOnBeingHitOverrideSet) == 0xe0);

#endif // FABLE_ENGINE_CTHINGGAMEOBJECT_H
