#ifndef FABLE_ENGINE_CCREATUREACTION_CASTWILLFORCESPELL_H
#define FABLE_ENGINE_CCREATUREACTION_CASTWILLFORCESPELL_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_CastWillForceSpell = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_CastWillForceSpell {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_CastWillForceSpell) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillForceSpell, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillForceSpell, ImmediateCast) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillForceSpell, OneAnimCast) == 0x12d);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillForceSpell, LevelToCast) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_CASTWILLFORCESPELL_H
