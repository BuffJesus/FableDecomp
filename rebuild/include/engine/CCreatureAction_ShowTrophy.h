#ifndef FABLE_ENGINE_CCREATUREACTION_SHOWTROPHY_H
#define FABLE_ENGINE_CCREATUREACTION_SHOWTROPHY_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ShowTrophy = 0xcc.
...
#pragma pack(push, 1)
struct CCreatureAction_ShowTrophy {
    ...
    unsigned char PTrophyBeingShown[0x8];                    // +0xb4 CIntelligentPointer<CThing>
    unsigned long ShowingTrophyDeedHandle;                   // +0xbc
    bool          PostedDeed;                                // +0xc0
    unsigned char PEmitter[0xb];                             // +0xc1 CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ShowTrophy) == 0xcc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShowTrophy, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShowTrophy, PTrophyBeingShown) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShowTrophy, ShowingTrophyDeedHandle) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShowTrophy, PostedDeed) == 0xc0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShowTrophy, PEmitter) == 0xc1);

#endif // FABLE_ENGINE_CCREATUREACTION_SHOWTROPHY_H
