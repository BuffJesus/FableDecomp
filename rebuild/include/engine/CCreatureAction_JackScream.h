#ifndef FABLE_ENGINE_CCREATUREACTION_JACKSCREAM_H
#define FABLE_ENGINE_CCREATUREACTION_JACKSCREAM_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_JackScream = 0x134.
...
struct CModeJackOfBladesScream;

#pragma pack(push, 1)
struct CCreatureAction_JackScream {
    ...
    CModeJackOfBladesScream* PModeCountedPointer_Data;       // +0x12c CCountedPointer<NCreatureMode::CModeJackOfBladesScream>::Data
    CCPPointerInfo*          PModeCountedPointer_Info;       // +0x130 CCountedPointer<NCreatureMode::CModeJackOfBladesScream>::Info
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_JackScream) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_JackScream, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_JackScream, PModeCountedPointer_Data) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_JackScream, PModeCountedPointer_Info) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_JACKSCREAM_H
