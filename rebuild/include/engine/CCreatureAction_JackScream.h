...
struct CCreatureAction_JackScream {
    ...
    unsigned char PModeCountedPointer[0x8];                  // +0x12c CCountedPointer<NCreatureMode::CModeJackOfBladesScream>
};
#pragma pack(pop)
...
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_JackScream, PModeCountedPointer) == 0x12c);
