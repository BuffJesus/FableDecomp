#ifndef FABLE_ENGINE_C3DMESHFILETRANSFORMATIONCHUNK_H
#define FABLE_ENGINE_C3DMESHFILETRANSFORMATIONCHUNK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof C3DMeshFileTransformationChunk = 0x64.
...
struct C3DMeshFileTransformationChunk {
    ...
    unsigned char Transform[0x30];                           // +0x34 CMatrix3x4
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(C3DMeshFileTransformationChunk) == 0x64);
FABLE_STATIC_ASSERT(offsetof(C3DMeshFileTransformationChunk, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(C3DMeshFileTransformationChunk, Transform) == 0x34);

#endif // FABLE_ENGINE_C3DMESHFILETRANSFORMATIONCHUNK_H
