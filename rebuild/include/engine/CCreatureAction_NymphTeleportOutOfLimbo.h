#ifndef FABLE_ENGINE_CCREATUREACTION_NYMPHTELEPORTOUTOFLIMBO_H
#define FABLE_ENGINE_CCREATUREACTION_NYMPHTELEPORTOUTOFLIMBO_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_NymphTeleportOutOfLimbo = 0x138.
...
#pragma pack(push, 1)
struct CCreatureAction_NymphTeleportOutOfLimbo {
    ...
    float         NewPos_X;                                  // +0x12c C3DVector::X
    float         NewPos_Y;                                  // +0x130 C3DVector::Y
    float         NewPos_Z;                                  // +0x134 C3DVector::Z
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_NymphTeleportOutOfLimbo) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_NymphTeleportOutOfLimbo, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_NymphTeleportOutOfLimbo, NewPos_X) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_NymphTeleportOutOfLimbo, NewPos_Y) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_NymphTeleportOutOfLimbo, NewPos_Z) == 0x134);

#endif // FABLE_ENGINE_CCREATUREACTION_NYMPHTELEPORTOUTOFLIMBO_H
