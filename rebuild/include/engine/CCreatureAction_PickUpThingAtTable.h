#ifndef FABLE_ENGINE_CCREATUREACTION_PICKUPTHINGATTABLE_H
#define FABLE_ENGINE_CCREATUREACTION_PICKUPTHINGATTABLE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_PickUpThingAtTable = 0xc0.
...
#pragma pack(push, 1)
struct CCreatureAction_PickUpThingAtTable {
    ...
    unsigned char PThingToPickUp[0x8];                       // +0xb4 CIntelligentPointer<CThing>
    unsigned char Mode[0x4];                                 // +0xbc EMode
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_PickUpThingAtTable) == 0xc0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PickUpThingAtTable, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PickUpThingAtTable, PThingToPickUp) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PickUpThingAtTable, Mode) == 0xbc);

#endif // FABLE_ENGINE_CCREATUREACTION_PICKUPTHINGATTABLE_H
