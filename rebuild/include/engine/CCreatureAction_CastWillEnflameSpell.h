#ifndef FABLE_ENGINE_CCREATUREACTION_CASTWILLENFLAMESPELL_H
#define FABLE_ENGINE_CCREATUREACTION_CASTWILLENFLAMESPELL_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_CastWillEnflameSpell = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_CastWillEnflameSpell {
    ...
    long          Level;                                     // +0x12c
    bool          IsZTargetting;                             // +0x130
    unsigned char _pad_0x131[0x3];                           // +0x131
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_CastWillEnflameSpell) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillEnflameSpell, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillEnflameSpell, Level) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_CastWillEnflameSpell, IsZTargetting) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_CASTWILLENFLAMESPELL_H
