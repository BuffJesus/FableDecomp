#ifndef FABLE_ENGINE_CCREATUREACTION_DUCKANDCOVER_H
#define FABLE_ENGINE_CCREATUREACTION_DUCKANDCOVER_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_DuckAndCover = 0x138.
...
#pragma pack(push, 1)
struct CCreatureAction_DuckAndCover {
    ...
    float         FacingDirection_X;                         // +0x12c C3DVector::X
    float         FacingDirection_Y;                         // +0x130 C3DVector::Y
    float         FacingDirection_Z;                         // +0x134 C3DVector::Z
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_DuckAndCover) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DuckAndCover, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DuckAndCover, FacingDirection_X) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DuckAndCover, FacingDirection_Y) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_DuckAndCover, FacingDirection_Z) == 0x134);

#endif // FABLE_ENGINE_CCREATUREACTION_DUCKANDCOVER_H
