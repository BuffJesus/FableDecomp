#ifndef FABLE_ENGINE_CCREATUREACTION_USEWALLMOUNT_H
#define FABLE_ENGINE_CCREATUREACTION_USEWALLMOUNT_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_UseWallMount = 0xbc.
...
#pragma pack(push, 1)
struct CCreatureAction_UseWallMount {
    ...
    unsigned char PObjectToUse[0x8];                         // +0xb4 CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_UseWallMount) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UseWallMount, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UseWallMount, PObjectToUse) == 0xb4);

#endif // FABLE_ENGINE_CCREATUREACTION_USEWALLMOUNT_H
