#ifndef FABLE_ENGINE_CCREATUREACTION_GETOUTOFBED_H
#define FABLE_ENGINE_CCREATUREACTION_GETOUTOFBED_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_GetOutOfBed = 0xbc.
...
struct CCreatureAction_GetOutOfBed {
    ...
    bool          interrupted;                               // +0x62 retail-only bool (previous header)
