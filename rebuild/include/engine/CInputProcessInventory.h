#ifndef FABLE_ENGINE_CINPUTPROCESSINVENTORY_H
#define FABLE_ENGINE_CINPUTPROCESSINVENTORY_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CInputProcessInventory = 0x38.
...
struct CInputProcessInventory {
    ...
    CTCInventory* PInventory;                                // +0x34
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CInputProcessInventory) == 0x38);
FABLE_STATIC_ASSERT(offsetof(CInputProcessInventory, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CInputProcessInventory, PInventory) == 0x34);

#endif // FABLE_ENGINE_CINPUTPROCESSINVENTORY_H
