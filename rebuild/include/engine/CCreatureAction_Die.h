#ifndef FABLE_ENGINE_CCREATUREACTION_DIE_H
#define FABLE_ENGINE_CCREATUREACTION_DIE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_Die = 0xb8.
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_Die) == 0xb8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_Die, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_Die, Flip) == 0xb4);

#endif // FABLE_ENGINE_CCREATUREACTION_DIE_H
