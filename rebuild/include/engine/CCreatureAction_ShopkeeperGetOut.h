#ifndef FABLE_ENGINE_CCREATUREACTION_SHOPKEEPERGETOUT_H
#define FABLE_ENGINE_CCREATUREACTION_SHOPKEEPERGETOUT_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ShopkeeperGetOut = 0xe0.
...
#pragma pack(push, 1)
struct CCreatureAction_ShopkeeperGetOut {
    ...
    CTCShop*      TCShop;                                    // +0xb4
    long          Goods;                                     // +0xb8
    float         Pos_X;                                     // +0xbc C3DVector::X
    float         Pos_Y;                                     // +0xc0 C3DVector::Y
    float         Pos_Z;                                     // +0xc4 C3DVector::Z
    unsigned char RHSet[0x18];                               // +0xc8 CRightHandedSet
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ShopkeeperGetOut) == 0xe0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShopkeeperGetOut, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShopkeeperGetOut, TCShop) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShopkeeperGetOut, Goods) == 0xb8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShopkeeperGetOut, Pos_X) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShopkeeperGetOut, Pos_Y) == 0xc0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShopkeeperGetOut, Pos_Z) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShopkeeperGetOut, RHSet) == 0xc8);

#endif // FABLE_ENGINE_CCREATUREACTION_SHOPKEEPERGETOUT_H
