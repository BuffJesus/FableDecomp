#ifndef FABLE_ENGINE_CCREATUREACTION_RELEASETIMESPELL_H
#define FABLE_ENGINE_CCREATUREACTION_RELEASETIMESPELL_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ReleaseTimeSpell = 0x130.
...
#pragma pack(push, 1)
struct CCreatureAction_ReleaseTimeSpell {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ReleaseTimeSpell) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ReleaseTimeSpell, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ReleaseTimeSpell, HasteKey) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_RELEASETIMESPELL_H
