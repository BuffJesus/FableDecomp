#ifndef FABLE_ENGINE_CBRUSHLIBRARYDIALOG_H
#define FABLE_ENGINE_CBRUSHLIBRARYDIALOG_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CBrushLibraryDialog = 0x12c.
...
FABLE_STATIC_ASSERT(sizeof(CBrushLibraryDialog) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CBrushLibraryDialog, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CBrushLibraryDialog, ControlCentre) == 0x128);

#endif // FABLE_ENGINE_CBRUSHLIBRARYDIALOG_H
