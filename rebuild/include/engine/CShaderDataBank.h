#ifndef FABLE_ENGINE_CSHADERDATABANK_H
#define FABLE_ENGINE_CSHADERDATABANK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CShaderDataBank = 0x1a8.
...
struct CShaderDataBank {
    ...
    unsigned char     Shaders[0x10];                         // +0x174 CArray<CShaderBankEntry_*>
    CShaderPreParser* ShaderPreParser;                       // +0x184
    unsigned char     EntryParserStates[0x10];               // +0x188 map<unsigned_long,CCountedPointer<CShaderParserState>,std::less<unsigned_long>,std::allocator<std::pair<unsigned_long_const_,CCountedPointer<CShaderParserState>_>_>_>
    CCharStringData*  IntermediateFileFolder_PStringData;    // +0x198 CCharString::PStringData
    unsigned char     StateBlock[0xc];                       // +0x19c CShaderBankStateBlock
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CShaderDataBank) == 0x1a8);
FABLE_STATIC_ASSERT(offsetof(CShaderDataBank, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CShaderDataBank, Shaders) == 0x174);
FABLE_STATIC_ASSERT(offsetof(CShaderDataBank, ShaderPreParser) == 0x184);
FABLE_STATIC_ASSERT(offsetof(CShaderDataBank, EntryParserStates) == 0x188);
FABLE_STATIC_ASSERT(offsetof(CShaderDataBank, IntermediateFileFolder_PStringData) == 0x198);
FABLE_STATIC_ASSERT(offsetof(CShaderDataBank, StateBlock) == 0x19c);

#endif // FABLE_ENGINE_CSHADERDATABANK_H
