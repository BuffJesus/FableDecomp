#ifndef FABLE_ENGINE_CCREATUREACTION_UNSHEATHETOSHOWTOSHEATHETROPHY_H
#define FABLE_ENGINE_CCREATUREACTION_UNSHEATHETOSHOWTOSHEATHETROPHY_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_UnsheatheToShowToSheatheTrophy = 0xd0.
...
#pragma pack(push, 1)
struct CCreatureAction_UnsheatheToShowToSheatheTrophy {
    ...
    CCharStringData* ShowAnimName_PStringData;               // +0xc4 CCharString::PStringData
    unsigned char    Trophy[0x8];                            // +0xc8 CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_UnsheatheToShowToSheatheTrophy) == 0xd0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheToShowToSheatheTrophy, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheToShowToSheatheTrophy, ShowAnimName_PStringData) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheToShowToSheatheTrophy, Trophy) == 0xc8);

#endif // FABLE_ENGINE_CCREATUREACTION_UNSHEATHETOSHOWTOSHEATHETROPHY_H
