#ifndef FABLE_ENGINE_CCREATUREACTION_PLAYCONVERSATIONANIMATION_H
#define FABLE_ENGINE_CCREATUREACTION_PLAYCONVERSATIONANIMATION_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_PlayConversationAnimation = 0xbc.
...
#pragma pack(push, 1)
struct CCreatureAction_PlayConversationAnimation {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_PlayConversationAnimation) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayConversationAnimation, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayConversationAnimation, UseAnimationMovement) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayConversationAnimation, Duration) == 0xb8);

#endif // FABLE_ENGINE_CCREATUREACTION_PLAYCONVERSATIONANIMATION_H
