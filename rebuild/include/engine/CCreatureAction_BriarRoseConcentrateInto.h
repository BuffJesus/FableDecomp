#ifndef FABLE_ENGINE_CCREATUREACTION_BRIARROSECONCENTRATEINTO_H
#define FABLE_ENGINE_CCREATUREACTION_BRIARROSECONCENTRATEINTO_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_BriarRoseConcentrateInto = 0x138.
...
#pragma pack(push, 1)
struct CCreatureAction_BriarRoseConcentrateInto {
    ...
    bool          Imposter;                                  // +0x12c
    unsigned char PEnemy[0xb];                               // +0x12d CIntelligentPointer<CThingCreatureBase>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_BriarRoseConcentrateInto) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BriarRoseConcentrateInto, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BriarRoseConcentrateInto, Imposter) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BriarRoseConcentrateInto, PEnemy) == 0x12d);

#endif // FABLE_ENGINE_CCREATUREACTION_BRIARROSECONCENTRATEINTO_H
