#ifndef FABLE_ENGINE_CCREATUREACTION_UNSHEATHEITEMFROMINVENTORYWITHHASTEACTION_H
#define FABLE_ENGINE_CCREATUREACTION_UNSHEATHEITEMFROMINVENTORYWITHHASTEACTION_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_UnsheatheItemFromInventoryWithHasteAction = 0xc8.
...
#pragma pack(push, 1)
struct CCreatureAction_UnsheatheItemFromInventoryWithHasteAction {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_UnsheatheItemFromInventoryWithHasteAction) == 0xc8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheItemFromInventoryWithHasteAction, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UnsheatheItemFromInventoryWithHasteAction, HasteKey) == 0xc4);

#endif // FABLE_ENGINE_CCREATUREACTION_UNSHEATHEITEMFROMINVENTORYWITHHASTEACTION_H
