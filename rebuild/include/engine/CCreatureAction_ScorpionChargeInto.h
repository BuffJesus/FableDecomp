#ifndef FABLE_ENGINE_CCREATUREACTION_SCORPIONCHARGEINTO_H
#define FABLE_ENGINE_CCREATUREACTION_SCORPIONCHARGEINTO_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ScorpionChargeInto = 0x138.
...
#pragma pack(push, 1)
struct CCreatureAction_ScorpionChargeInto {
    ...
    unsigned char PObstruction[0x8];                         // +0x130 CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ScorpionChargeInto) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionChargeInto, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionChargeInto, ChargeDistance) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ScorpionChargeInto, PObstruction) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_SCORPIONCHARGEINTO_H
