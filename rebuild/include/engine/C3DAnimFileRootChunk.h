#ifndef FABLE_ENGINE_C3DANIMFILEROOTCHUNK_H
#define FABLE_ENGINE_C3DANIMFILEROOTCHUNK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof C3DAnimFileRootChunk = 0x3c.
...
FABLE_STATIC_ASSERT(sizeof(C3DAnimFileRootChunk) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(C3DAnimFileRootChunk, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(C3DAnimFileRootChunk, LoopFlag) == 0x34);
FABLE_STATIC_ASSERT(offsetof(C3DAnimFileRootChunk, Duration) == 0x38);

#endif // FABLE_ENGINE_C3DANIMFILEROOTCHUNK_H
