#ifndef FABLE_ENGINE_CCOMBATACTION_GENERICSTRIKERESPONSEKNOCKDOWNRECOVERBASE_H
#define FABLE_ENGINE_CCOMBATACTION_GENERICSTRIKERESPONSEKNOCKDOWNRECOVERBASE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCombatAction_GenericStrikeResponseKnockdownRecoverBase = 0x130.
...
#pragma pack(push, 1)
struct CCombatAction_GenericStrikeResponseKnockdownRecoverBase {
...
FABLE_STATIC_ASSERT(sizeof(CCombatAction_GenericStrikeResponseKnockdownRecoverBase) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseKnockdownRecoverBase, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseKnockdownRecoverBase, CanBeHit) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseKnockdownRecoverBase, Flip) == 0x12d);

#endif // FABLE_ENGINE_CCOMBATACTION_GENERICSTRIKERESPONSEKNOCKDOWNRECOVERBASE_H
