...
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, PointOfHit) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, DirectionOfHit) == 0x140);
...
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, DustTravelDirection) == 0x154);
