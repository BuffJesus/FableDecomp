#ifndef FABLE_ENGINE_CCREATUREACTION_PLAYCOMBATANIMATION_H
#define FABLE_ENGINE_CCREATUREACTION_PLAYCOMBATANIMATION_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_PlayCombatAnimation = 0x130.
...
#pragma pack(push, 1)
struct CCreatureAction_PlayCombatAnimation {
    ...
    unsigned char f;                                         // +0x114 retail-only (CCreatureActionPlayCombatAnimation_IsToFaceTarget_008b8660.cpp)
    unsigned char f_2;                                       // +0x115 retail-only (CCreatureActionPlayCombatAnimation_IsMovementUsingPhysics_008b8670.cpp)
    unsigned char f_3;                                       // +0x116 retail-only (CCreatureActionPlayCombatAnimation_IsAlwaysUseAnimationMovement_008b8680.cpp)
    ...
    bool          FaceTarget;                                // +0x12c
    bool          UsePhysics;                                // +0x12d
    bool          AlwaysUseMovementInAnim;                   // +0x12e
    unsigned char _pad_0x12f[0x1];                           // +0x12f
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_PlayCombatAnimation) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayCombatAnimation, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayCombatAnimation, f) == 0x114);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayCombatAnimation, f_2) == 0x115);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayCombatAnimation, f_3) == 0x116);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayCombatAnimation, FaceTarget) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayCombatAnimation, UsePhysics) == 0x12d);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayCombatAnimation, AlwaysUseMovementInAnim) == 0x12e);

#endif // FABLE_ENGINE_CCREATUREACTION_PLAYCOMBATANIMATION_H
