#ifndef FABLE_ENGINE_CCREATUREACTION_BRIARROSESHOTFAROUTOF_H
#define FABLE_ENGINE_CCREATUREACTION_BRIARROSESHOTFAROUTOF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_BriarRoseShotFarOutof = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_BriarRoseShotFarOutof {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_BriarRoseShotFarOutof) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BriarRoseShotFarOutof, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BriarRoseShotFarOutof, PShot) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_BRIARROSESHOTFAROUTOF_H
