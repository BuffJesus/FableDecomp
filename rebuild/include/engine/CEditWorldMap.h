#ifndef FABLE_ENGINE_CEDITWORLDMAP_H
#define FABLE_ENGINE_CEDITWORLDMAP_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CEditWorldMap = 0x14c.
...
struct CEditWorldMap {
    ...
    unsigned char   EditMapInfo[0x10];                       // +0xfc vector<CEditMapInfo,std::allocator<CEditMapInfo>_>
    CEditComponent* EditComponent;                           // +0x10c
    unsigned char   EditRegions[0x10];                       // +0x110 vector<CEditRegion,std::allocator<CEditRegion>_>
    unsigned char   MapsAlteredByPen[0x10];                  // +0x120 set<long,std::less<long>,std::allocator<long>_>
    unsigned char   WaterDefs[0x10];                         // +0x130 map<float,unsigned_long,std::less<float>,std::allocator<std::pair<float_const_,unsigned_long>_>_>
    unsigned long   WaterSelectedDefGroupIndex;              // +0x140
    unsigned long   AutoSaveTimer;                           // +0x144
    bool            EnableEditorAutosave;                    // +0x148
    bool            SaveToBackupFiles;                       // +0x149
    unsigned char   _pad_0x14a[0x2];                         // +0x14a
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CEditWorldMap) == 0x14c);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, EditMapInfo) == 0xfc);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, EditComponent) == 0x10c);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, EditRegions) == 0x110);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, MapsAlteredByPen) == 0x120);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, WaterDefs) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, WaterSelectedDefGroupIndex) == 0x140);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, AutoSaveTimer) == 0x144);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, EnableEditorAutosave) == 0x148);
FABLE_STATIC_ASSERT(offsetof(CEditWorldMap, SaveToBackupFiles) == 0x149);

#endif // FABLE_ENGINE_CEDITWORLDMAP_H
