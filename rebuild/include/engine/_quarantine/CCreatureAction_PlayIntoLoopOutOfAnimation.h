#ifndef FABLE_ENGINE_CCREATUREACTION_PLAYINTOLOOPOUTOFANIMATION_H
#define FABLE_ENGINE_CCREATUREACTION_PLAYINTOLOOPOUTOFANIMATION_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_PlayIntoLoopOutOfAnimation = 0xd0.
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_PlayIntoLoopOutOfAnimation) == 0xd0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayIntoLoopOutOfAnimation, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayIntoLoopOutOfAnimation, Stage) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_PlayIntoLoopOutOfAnimation, NumberOfTimesToLoop) == 0xb8);
