#ifndef FABLE_ENGINE_CTHUNDERBATTLEDEF_H
#define FABLE_ENGINE_CTHUNDERBATTLEDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CThunderBattleDef = 0x50.
...
struct CThunderBattleDef {
    ...
    long          BattleChargeLevel;                         // +0x4c
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CThunderBattleDef) == 0x50);
FABLE_STATIC_ASSERT(offsetof(CThunderBattleDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CThunderBattleDef, f3c) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(CThunderBattleDef, NumGetHitsBeforeStormAttack) == 0x40);
FABLE_STATIC_ASSERT(offsetof(CThunderBattleDef, NumMissesBeforeStormAttack) == 0x44);
FABLE_STATIC_ASSERT(offsetof(CThunderBattleDef, LightningDamage) == 0x48);
FABLE_STATIC_ASSERT(offsetof(CThunderBattleDef, BattleChargeLevel) == 0x4c);

#endif // FABLE_ENGINE_CTHUNDERBATTLEDEF_H
