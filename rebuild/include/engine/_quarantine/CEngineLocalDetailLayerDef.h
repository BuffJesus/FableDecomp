#ifndef FABLE_ENGINE_CENGINELOCALDETAILLAYERDEF_H
#define FABLE_ENGINE_CENGINELOCALDETAILLAYERDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CEngineLocalDetailLayerDef = 0x60.
...
FABLE_STATIC_ASSERT(sizeof(CEngineLocalDetailLayerDef) == 0x60);
FABLE_STATIC_ASSERT(offsetof(CEngineLocalDetailLayerDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CEngineLocalDetailLayerDef, m3c) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(CEngineLocalDetailLayerDef, SpacingFromLayer) == 0x40);
FABLE_STATIC_ASSERT(offsetof(CEngineLocalDetailLayerDef, Objects) == 0x50);

#endif // FABLE_ENGINE_CENGINELOCALDETAILLAYERDEF_H
