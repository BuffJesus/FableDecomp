#ifndef FABLE_ENGINE_CTHINGNOISEDEF_H
#define FABLE_ENGINE_CTHINGNOISEDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CThingNoiseDef = 0xa8.
...
FABLE_STATIC_ASSERT(sizeof(CThingNoiseDef) == 0xa8);
FABLE_STATIC_ASSERT(offsetof(CThingNoiseDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CThingNoiseDef, member) == 0x70);
FABLE_STATIC_ASSERT(offsetof(CThingNoiseDef, Noise) == 0x74);

#endif // FABLE_ENGINE_CTHINGNOISEDEF_H
