#ifndef FABLE_ENGINE_CCREATUREABILITYDEF_H
#define FABLE_ENGINE_CCREATUREABILITYDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAbilityDef = 0x44.
...
struct CCreatureAbilityDef {
    ...
    unsigned char Type[0x4];                                 // +0x40 ECreatureAbility
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAbilityDef) == 0x44);
FABLE_STATIC_ASSERT(offsetof(CCreatureAbilityDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAbilityDef, Type) == 0x40);

#endif // FABLE_ENGINE_CCREATUREABILITYDEF_H
