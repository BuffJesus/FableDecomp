#ifndef FABLE_ENGINE_CENGINEINTERNALPRIMITIVEMORPHEDANIMATEDMESH_H
#define FABLE_ENGINE_CENGINEINTERNALPRIMITIVEMORPHEDANIMATEDMESH_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CEngineInternalPrimitiveMorphedAnimatedMesh = 0x174.
...
#pragma pack(push, 1)
struct CEngineInternalPrimitiveMorphedAnimatedMesh {
    ...
    long          sub;                                       // +0x128 retail-only Sub (CEngineInternalPrimitiveMorphedAnimatedMesh_Update_00bd2b70.cpp)
    unsigned char Morph[0x48];                               // +0x12c CEngineInternalPrimitiveMorphInfo
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CEngineInternalPrimitiveMorphedAnimatedMesh) == 0x174);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveMorphedAnimatedMesh, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveMorphedAnimatedMesh, sub) == 0x128);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveMorphedAnimatedMesh, Morph) == 0x12c);

#endif // FABLE_ENGINE_CENGINEINTERNALPRIMITIVEMORPHEDANIMATEDMESH_H
