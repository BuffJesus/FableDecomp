#ifndef FABLE_ENGINE_CSIMBUILDINGDEF_H
#define FABLE_ENGINE_CSIMBUILDINGDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CSimBuildingDef = 0x4c.
...
FABLE_STATIC_ASSERT(sizeof(CSimBuildingDef) == 0x4c);
FABLE_STATIC_ASSERT(offsetof(CSimBuildingDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CSimBuildingDef, fieldA) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(CSimBuildingDef, Property) == 0x40);
FABLE_STATIC_ASSERT(offsetof(CSimBuildingDef, WorkSpaces) == 0x44);
FABLE_STATIC_ASSERT(offsetof(CSimBuildingDef, LiveSpaces) == 0x48);

#endif // FABLE_ENGINE_CSIMBUILDINGDEF_H
