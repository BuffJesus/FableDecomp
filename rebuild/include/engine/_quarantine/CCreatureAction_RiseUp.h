#ifndef FABLE_ENGINE_CCREATUREACTION_RISEUP_H
#define FABLE_ENGINE_CCREATUREACTION_RISEUP_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_RiseUp = 0x130.
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_RiseUp) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_RiseUp, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_RiseUp, f) == 0x114);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_RiseUp, FaceTarget) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_RISEUP_H
