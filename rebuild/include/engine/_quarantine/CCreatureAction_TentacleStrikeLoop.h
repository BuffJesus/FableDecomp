#ifndef FABLE_ENGINE_CCREATUREACTION_TENTACLESTRIKELOOP_H
#define FABLE_ENGINE_CCREATUREACTION_TENTACLESTRIKELOOP_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_TentacleStrikeLoop = 0x138.
...
#pragma pack(push, 1)
struct CCreatureAction_TentacleStrikeLoop {
    ...
    long          StartTick;                                 // +0x12c
    bool          Interrupt;                                 // +0x130
    unsigned char _pad_0x131[0x3];                           // +0x131
    float         StartHealth;                               // +0x134
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_TentacleStrikeLoop) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_TentacleStrikeLoop, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_TentacleStrikeLoop, StartTick) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_TentacleStrikeLoop, Interrupt) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_TentacleStrikeLoop, StartHealth) == 0x134);

#endif // FABLE_ENGINE_CCREATUREACTION_TENTACLESTRIKELOOP_H
