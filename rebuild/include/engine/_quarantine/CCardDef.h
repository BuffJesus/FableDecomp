#ifndef FABLE_ENGINE_CCARDDEF_H
#define FABLE_ENGINE_CCARDDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCardDef = 0x48.
...
FABLE_STATIC_ASSERT(sizeof(CCardDef) == 0x48);
FABLE_STATIC_ASSERT(offsetof(CCardDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCardDef, m3c) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(CCardDef, CardName) == 0x40);
FABLE_STATIC_ASSERT(offsetof(CCardDef, CardVal) == 0x44);

#endif // FABLE_ENGINE_CCARDDEF_H
