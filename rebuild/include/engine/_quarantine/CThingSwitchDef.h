#ifndef FABLE_ENGINE_CTHINGSWITCHDEF_H
#define FABLE_ENGINE_CTHINGSWITCHDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CThingSwitchDef = 0x78.
...
FABLE_STATIC_ASSERT(sizeof(CThingSwitchDef) == 0x78);
FABLE_STATIC_ASSERT(offsetof(CThingSwitchDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CThingSwitchDef, f70) == 0x70);
FABLE_STATIC_ASSERT(offsetof(CThingSwitchDef, TriggerType) == 0x74);

#endif // FABLE_ENGINE_CTHINGSWITCHDEF_H
