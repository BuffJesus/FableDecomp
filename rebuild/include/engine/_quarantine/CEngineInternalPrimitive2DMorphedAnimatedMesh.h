#ifndef FABLE_ENGINE_CENGINEINTERNALPRIMITIVE2DMORPHEDANIMATEDMESH_H
#define FABLE_ENGINE_CENGINEINTERNALPRIMITIVE2DMORPHEDANIMATEDMESH_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CEngineInternalPrimitive2DMorphedAnimatedMesh = 0x19c.
...
#pragma pack(push, 1)
struct CEngineInternalPrimitive2DMorphedAnimatedMesh {
...
FABLE_STATIC_ASSERT(sizeof(CEngineInternalPrimitive2DMorphedAnimatedMesh) == 0x19c);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitive2DMorphedAnimatedMesh, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitive2DMorphedAnimatedMesh, sub) == 0x150);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitive2DMorphedAnimatedMesh, Morph) == 0x154);

#endif // FABLE_ENGINE_CENGINEINTERNALPRIMITIVE2DMORPHEDANIMATEDMESH_H
