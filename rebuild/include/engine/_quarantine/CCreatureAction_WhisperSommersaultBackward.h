#ifndef FABLE_ENGINE_CCREATUREACTION_WHISPERSOMMERSAULTBACKWARD_H
#define FABLE_ENGINE_CCREATUREACTION_WHISPERSOMMERSAULTBACKWARD_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_WhisperSommersaultBackward = 0x130.
...
#pragma pack(push, 1)
struct CCreatureAction_WhisperSommersaultBackward {
    ...
    unsigned char f;                                         // +0x114 retail-only unsigned char (CCreatureActionWhisperSommersaultBackward_PerformAction_008c0620.cpp)
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_WhisperSommersaultBackward) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_WhisperSommersaultBackward, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_WhisperSommersaultBackward, f) == 0x114);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_WhisperSommersaultBackward, Landed) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_WHISPERSOMMERSAULTBACKWARD_H
