#ifndef FABLE_ENGINE_CSPECIALABILITIESCREATURETINTDEF_H
#define FABLE_ENGINE_CSPECIALABILITIESCREATURETINTDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CSpecialAbilitiesCreatureTintDef = 0x58.
...
FABLE_STATIC_ASSERT(sizeof(CSpecialAbilitiesCreatureTintDef) == 0x58);
FABLE_STATIC_ASSERT(offsetof(CSpecialAbilitiesCreatureTintDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CSpecialAbilitiesCreatureTintDef, fieldA) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(CSpecialAbilitiesCreatureTintDef, FadeInTimeSecs) == 0x40);
FABLE_STATIC_ASSERT(offsetof(CSpecialAbilitiesCreatureTintDef, FadeOutTimeSecs) == 0x44);
FABLE_STATIC_ASSERT(offsetof(CSpecialAbilitiesCreatureTintDef, Color) == 0x48);

#endif // FABLE_ENGINE_CSPECIALABILITIESCREATURETINTDEF_H
