#ifndef FABLE_ENGINE_CTAVERNGAMESHOVEHAPENNYDEF_H
#define FABLE_ENGINE_CTAVERNGAMESHOVEHAPENNYDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CTavernGameShoveHaPennyDef = 0x208.
...
#pragma pack(push, 1)
struct CTavernGameShoveHaPennyDef {
    ...
    unsigned char Regions[0x10];                             // +0x1a8 vector<CShoveHaPennyRegionDef,std::allocator<CShoveHaPennyRegionDef>_>
    long          BoardDefIndex;                             // +0x1b8
    long          ArrowDefIndex;                             // +0x1bc
    float         PositionCoinSpeedXbox;                     // +0x1c0
    float         PositionCoinSpeedPC;                       // +0x1c4
    float         PositionCoinMinimum;                       // +0x1c8
    float         PositionCoinMaximum;                       // +0x1cc
    float         PositionCoinDepth;                         // +0x1d0
    float         ImpulseScale;                              // +0x1d4
    float         TargetDistanceScale;                       // +0x1d8
    float         JoystickScaleXboxX;                        // +0x1dc
    float         JoystickScaleXboxY;                        // +0x1e0
    float         JoystickScalePCX;                          // +0x1e4
    float         JoystickScalePCY;                          // +0x1e8
    float         JoystickTranslateY;                        // +0x1ec
    float         JoystickMagBelow;                          // +0x1f0
    float         AverageJoystickMagAbove;                   // +0x1f4
    float         AverageDrift;                              // +0x1f8
    float         MaxPower;                                  // +0x1fc
    float         RestSpeed;                                 // +0x200
    long          Rounds;                                    // +0x204
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CTavernGameShoveHaPennyDef) == 0x208);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, Regions) == 0x1a8);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, BoardDefIndex) == 0x1b8);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, ArrowDefIndex) == 0x1bc);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, PositionCoinSpeedXbox) == 0x1c0);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, PositionCoinSpeedPC) == 0x1c4);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, PositionCoinMinimum) == 0x1c8);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, PositionCoinMaximum) == 0x1cc);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, PositionCoinDepth) == 0x1d0);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, ImpulseScale) == 0x1d4);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, TargetDistanceScale) == 0x1d8);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, JoystickScaleXboxX) == 0x1dc);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, JoystickScaleXboxY) == 0x1e0);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, JoystickScalePCX) == 0x1e4);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, JoystickScalePCY) == 0x1e8);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, JoystickTranslateY) == 0x1ec);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, JoystickMagBelow) == 0x1f0);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, AverageJoystickMagAbove) == 0x1f4);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, AverageDrift) == 0x1f8);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, MaxPower) == 0x1fc);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, RestSpeed) == 0x200);
FABLE_STATIC_ASSERT(offsetof(CTavernGameShoveHaPennyDef, Rounds) == 0x204);

#endif // FABLE_ENGINE_CTAVERNGAMESHOVEHAPENNYDEF_H
