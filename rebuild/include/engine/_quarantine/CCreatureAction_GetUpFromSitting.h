#ifndef FABLE_ENGINE_CCREATUREACTION_GETUPFROMSITTING_H
#define FABLE_ENGINE_CCREATUREACTION_GETUPFROMSITTING_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_GetUpFromSitting = 0x134.
...
#pragma pack(push, 1)
struct CCreatureAction_GetUpFromSitting {
    ...
    long          SittingMode;                               // +0x12c
    bool          RemoveOnPerformAction;                     // +0x130
    unsigned char _pad_0x131[0x3];                           // +0x131
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_GetUpFromSitting) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetUpFromSitting, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetUpFromSitting, m_a) == 0x10);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetUpFromSitting, m_b) == 0x14);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetUpFromSitting, SittingMode) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_GetUpFromSitting, RemoveOnPerformAction) == 0x130);

#endif // FABLE_ENGINE_CCREATUREACTION_GETUPFROMSITTING_H
