#ifndef FABLE_ENGINE_CENGINEINTERNALPRIMITIVEMORPHEDSTATICMESH_H
#define FABLE_ENGINE_CENGINEINTERNALPRIMITIVEMORPHEDSTATICMESH_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CEngineInternalPrimitiveMorphedStaticMesh = 0xf4.
...
#pragma pack(push, 1)
struct CEngineInternalPrimitiveMorphedStaticMesh {
    void*         __vftable;                                 // +0x00 vptr, or first dword of a flattened base subobject
    unsigned char _pad_0x04[0x4];                            // +0x04
    unsigned char _pad_0x08[0x4];                            // +0x08
    unsigned long fc;                                        // +0x0c retail-only (CEngineInternalPrimitiveMorphedStaticMesh_Update_00b9e570.cpp)
    long          sub;                                       // +0x10 retail-only (CEngineInternalPrimitiveMorphedStaticMesh_Update_00b9e570.cpp)
    ...
    unsigned char Morph[0x48];                               // +0xac CEngineInternalPrimitiveMorphInfo
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CEngineInternalPrimitiveMorphedStaticMesh) == 0xf4);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveMorphedStaticMesh, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveMorphedStaticMesh, fc) == 0xc);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveMorphedStaticMesh, sub) == 0x10);
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveMorphedStaticMesh, Morph) == 0xac);

#endif // FABLE_ENGINE_CENGINEINTERNALPRIMITIVEMORPHEDSTATICMESH_H
