#ifndef FABLE_ENGINE_CATTACKPATTERNDEF_H
#define FABLE_ENGINE_CATTACKPATTERNDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CAttackPatternDef = 0x50.
...
FABLE_STATIC_ASSERT(sizeof(CAttackPatternDef) == 0x50);
FABLE_STATIC_ASSERT(offsetof(CAttackPatternDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CAttackPatternDef, sub) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(CAttackPatternDef, AttackPattern) == 0x40);

#endif // FABLE_ENGINE_CATTACKPATTERNDEF_H
