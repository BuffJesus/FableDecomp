#ifndef FABLE_ENGINE_CCAMERAMANAGERSETDEF_H
#define FABLE_ENGINE_CCAMERAMANAGERSETDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCameraManagerSetDef = 0x50.
...
struct CCameraManagerSetDef {
    ...
    long          CameraManagerPCCombat;                     // +0x4c
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCameraManagerSetDef) == 0x50);
FABLE_STATIC_ASSERT(offsetof(CCameraManagerSetDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCameraManagerSetDef, f3c) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(CCameraManagerSetDef, CameraManagerMain) == 0x40);
FABLE_STATIC_ASSERT(offsetof(CCameraManagerSetDef, CameraManagerCombat) == 0x44);
FABLE_STATIC_ASSERT(offsetof(CCameraManagerSetDef, CameraManagerPCMain) == 0x48);
FABLE_STATIC_ASSERT(offsetof(CCameraManagerSetDef, CameraManagerPCCombat) == 0x4c);

#endif // FABLE_ENGINE_CCAMERAMANAGERSETDEF_H
