#ifndef FABLE_ENGINE_CABILITYTRACKLEVELDEF_H
#define FABLE_ENGINE_CABILITYTRACKLEVELDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CAbilityTrackLevelDef = 0x4c.
...
FABLE_STATIC_ASSERT(sizeof(CAbilityTrackLevelDef) == 0x4c);
FABLE_STATIC_ASSERT(offsetof(CAbilityTrackLevelDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CAbilityTrackLevelDef, fieldA) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(CAbilityTrackLevelDef, ExperienceCost) == 0x40);
FABLE_STATIC_ASSERT(offsetof(CAbilityTrackLevelDef, AbilityUnlocked) == 0x44);
FABLE_STATIC_ASSERT(offsetof(CAbilityTrackLevelDef, Description) == 0x48);

#endif // FABLE_ENGINE_CABILITYTRACKLEVELDEF_H
