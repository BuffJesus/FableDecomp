#ifndef FABLE_ENGINE_CIDLESCHEDULERDEF_H
#define FABLE_ENGINE_CIDLESCHEDULERDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CIdleSchedulerDef = 0x50.
...
struct CIdleSchedulerDef {
    ...
    unsigned char Period[0x10];                              // +0x40 map<EIdleStateGroup,long,std::less<EIdleStateGroup>,std::allocator<std::pair<EIdleStateGroup_const_,long>_>_>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CIdleSchedulerDef) == 0x50);
FABLE_STATIC_ASSERT(offsetof(CIdleSchedulerDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CIdleSchedulerDef, Period) == 0x40);

#endif // FABLE_ENGINE_CIDLESCHEDULERDEF_H
