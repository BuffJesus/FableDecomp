...
// Retail evidence: 1 trusted landed function(s); reconciliation 7 conflict(s) in 1 file(s) vs 0 agreeing.
...
struct CEngineInternalPrimitiveText {
    ...
    unsigned long    fc;                                     // +0x0c retail-only unsigned long (CEngineInternalPrimitiveText_Update_00bc6810.cpp)
...
FABLE_STATIC_ASSERT(offsetof(CEngineInternalPrimitiveText, fc) == 0xc);
