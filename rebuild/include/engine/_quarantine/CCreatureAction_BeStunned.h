#ifndef FABLE_ENGINE_CCREATUREACTION_BESTUNNED_H
#define FABLE_ENGINE_CCREATUREACTION_BESTUNNED_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_BeStunned = 0xb8.
...
#pragma pack(push, 1)
struct CCreatureAction_BeStunned {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_BeStunned) == 0xb8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BeStunned, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BeStunned, Flip) == 0xb4);

#endif // FABLE_ENGINE_CCREATUREACTION_BESTUNNED_H
