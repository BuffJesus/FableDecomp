#ifndef FABLE_ENGINE_CCREATUREACTION_WHISPERSOMMERSAULTFORWARD_H
#define FABLE_ENGINE_CCREATUREACTION_WHISPERSOMMERSAULTFORWARD_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_WhisperSommersaultForward = 0x130.
...
#pragma pack(push, 1)
struct CCreatureAction_WhisperSommersaultForward {
    ...
    unsigned char f;                                         // +0x114 retail-only unsigned char (CCreatureActionWhisperSommersaultForward_IsToEvadeAllHits_0096bf70.cpp)
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_WhisperSommersaultForward) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_WhisperSommersaultForward, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_WhisperSommersaultForward, f) == 0x114);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_WhisperSommersaultForward, Landed) == 0x12c);

#endif // FABLE_ENGINE_CCREATUREACTION_WHISPERSOMMERSAULTFORWARD_H
