#ifndef FABLE_ENGINE_CCOMBATACTION_GENERICSTRIKERESPONSEBASE_H
#define FABLE_ENGINE_CCOMBATACTION_GENERICSTRIKERESPONSEBASE_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCombatAction_GenericStrikeResponseBase = 0x160.
...
struct CCombatAction_GenericStrikeResponseBase {
    ...
    float         DirectionOfHit_X;                          // +0x140 C3DVector::X
    float         DirectionOfHit_Y;                          // +0x144 C3DVector::Y
    float         DirectionOfHit_Z;                          // +0x148 C3DVector::Z
    bool          MoveOnHitOverride;                         // +0x14c
    bool          CreateDustEffect;                          // +0x14d
    unsigned char _pad_0x14e[0x2];                           // +0x14e
    long          FrameForDust;                              // +0x150
    float         DustTravelDirection_X;                     // +0x154 C3DVector::X
    float         DustTravelDirection_Y;                     // +0x158 C3DVector::Y
    float         DustTravelDirection_Z;                     // +0x15c C3DVector::Z
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCombatAction_GenericStrikeResponseBase) == 0x160);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, hitPos) == 0x11c);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, m_hitDir) == 0x128);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, PThingThatHit) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, PointOfHit_X) == 0x134);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, PointOfHit_Y) == 0x138);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, PointOfHit_Z) == 0x13c);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, DirectionOfHit_X) == 0x140);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, DirectionOfHit_Y) == 0x144);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, DirectionOfHit_Z) == 0x148);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, MoveOnHitOverride) == 0x14c);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, CreateDustEffect) == 0x14d);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, FrameForDust) == 0x150);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, DustTravelDirection_X) == 0x154);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, DustTravelDirection_Y) == 0x158);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_GenericStrikeResponseBase, DustTravelDirection_Z) == 0x15c);

#endif // FABLE_ENGINE_CCOMBATACTION_GENERICSTRIKERESPONSEBASE_H
