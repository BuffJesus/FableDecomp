#ifndef FABLE_ENGINE_COPINIONOFHERODEF_H
#define FABLE_ENGINE_COPINIONOFHERODEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof COpinionOfHeroDef = 0x3c.
...
FABLE_STATIC_ASSERT(offsetof(COpinionOfHeroDef, DeedMask) == 0x38);

#endif // FABLE_ENGINE_COPINIONOFHERODEF_H
