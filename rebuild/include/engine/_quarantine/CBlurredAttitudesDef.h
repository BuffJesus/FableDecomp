#ifndef FABLE_ENGINE_CBLURREDATTITUDESDEF_H
#define FABLE_ENGINE_CBLURREDATTITUDESDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CBlurredAttitudesDef = 0x50.
...
struct CBlurredAttitudesDef {
    ...
    unsigned char sub[0x4];                                  // +0x3c retail-only char (CBlurredAttitudesDef_Transfer_0067cdb0.cpp)
    unsigned char Attitudes[0x10];                           // +0x40 vector<EOpinionAttitudeType,std::allocator<EOpinionAttitudeType>_>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CBlurredAttitudesDef) == 0x50);
FABLE_STATIC_ASSERT(offsetof(CBlurredAttitudesDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CBlurredAttitudesDef, sub) == 0x3c);
FABLE_STATIC_ASSERT(offsetof(CBlurredAttitudesDef, Attitudes) == 0x40);

#endif // FABLE_ENGINE_CBLURREDATTITUDESDEF_H
