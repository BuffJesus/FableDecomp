#ifndef FABLE_ENGINE_CTHINGMARKERDEF_H
#define FABLE_ENGINE_CTHINGMARKERDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CThingMarkerDef = 0x8c.
...
struct CThingMarkerDef {
    ...
    unsigned char TriggerType[0x4];                          // +0x84 ESwitchTriggerType
    unsigned long Properties;                                // +0x88
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CThingMarkerDef) == 0x8c);
FABLE_STATIC_ASSERT(offsetof(CThingMarkerDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CThingMarkerDef, Graphic) == 0x74);
FABLE_STATIC_ASSERT(offsetof(CThingMarkerDef, TriggerType) == 0x84);
FABLE_STATIC_ASSERT(offsetof(CThingMarkerDef, Properties) == 0x88);

#endif // FABLE_ENGINE_CTHINGMARKERDEF_H
