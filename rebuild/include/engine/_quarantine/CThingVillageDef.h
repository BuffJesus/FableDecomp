#ifndef FABLE_ENGINE_CTHINGVILLAGEDEF_H
#define FABLE_ENGINE_CTHINGVILLAGEDEF_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CThingVillageDef = 0x84.
...
FABLE_STATIC_ASSERT(sizeof(CThingVillageDef) == 0x84);
FABLE_STATIC_ASSERT(offsetof(CThingVillageDef, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CThingVillageDef, member70) == 0x70);
FABLE_STATIC_ASSERT(offsetof(CThingVillageDef, Graphic) == 0x74);

#endif // FABLE_ENGINE_CTHINGVILLAGEDEF_H
