...
struct CCreatureAction_ActivateQuest {
    ...
    CCharStringData* ScriptName_PStringData;                 // +0xb4 CCharString::PStringData
...
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ActivateQuest, ScriptName_PStringData) == 0xb4);
