#ifndef FABLE_ENGINE_CCREATUREACTION_ACTIVATEQUEST_H
#define FABLE_ENGINE_CCREATUREACTION_ACTIVATEQUEST_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ActivateQuest = 0xc4.
...
#pragma pack(push, 1)
struct CCreatureAction_ActivateQuest {
    ...
    unsigned char f;                                         // +0x63 retail-only (CCreatureActionActivateQuest_IsActionReadyForInterruption_00842a10.cpp)
    ...
    unsigned char ScriptName[0x4];                           // +0xb4 CCharString
    bool          LoadResources;                             // +0xb8
    unsigned char PObjectToUse[0xb];                         // +0xb9 CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ActivateQuest) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ActivateQuest, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ActivateQuest, f) == 0x63);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ActivateQuest, ScriptName) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ActivateQuest, LoadResources) == 0xb8);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ActivateQuest, PObjectToUse) == 0xb9);

#endif // FABLE_ENGINE_CCREATUREACTION_ACTIVATEQUEST_H
