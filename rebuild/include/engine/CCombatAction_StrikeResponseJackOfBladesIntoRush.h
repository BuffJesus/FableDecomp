#ifndef FABLE_ENGINE_CCOMBATACTION_STRIKERESPONSEJACKOFBLADESINTORUSH_H
#define FABLE_ENGINE_CCOMBATACTION_STRIKERESPONSEJACKOFBLADESINTORUSH_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCombatAction_StrikeResponseJackOfBladesIntoRush = 0x164.
...
#pragma pack(push, 1)
struct CCombatAction_StrikeResponseJackOfBladesIntoRush {
    ...
    bool          CauseRush;                                 // +0x160
    unsigned char _pad_0x161[0x3];                           // +0x161
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCombatAction_StrikeResponseJackOfBladesIntoRush) == 0x164);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_StrikeResponseJackOfBladesIntoRush, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCombatAction_StrikeResponseJackOfBladesIntoRush, CauseRush) == 0x160);

#endif // FABLE_ENGINE_CCOMBATACTION_STRIKERESPONSEJACKOFBLADESINTORUSH_H
