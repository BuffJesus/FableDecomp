#ifndef FABLE_ENGINE_CCREATUREACTION_NYMPHGETHIT_H
#define FABLE_ENGINE_CCREATUREACTION_NYMPHGETHIT_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_NymphGetHit = 0x16c.
...
#pragma pack(push, 1)
struct CCreatureAction_NymphGetHit {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_NymphGetHit) == 0x16c);
