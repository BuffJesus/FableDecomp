#ifndef FABLE_ENGINE_CCREATUREACTION_SHOWITEMTOTHING_H
#define FABLE_ENGINE_CCREATUREACTION_SHOWITEMTOTHING_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_ShowItemToThing = 0xc4.
...
#pragma pack(push, 1)
struct CCreatureAction_ShowItemToThing {
    ...
    unsigned char PReceivingThing[0x8];                      // +0xb4 CIntelligentPointer<CThing>
    unsigned char PItemBeingShown[0x8];                      // +0xbc CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_ShowItemToThing) == 0xc4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShowItemToThing, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShowItemToThing, PReceivingThing) == 0xb4);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_ShowItemToThing, PItemBeingShown) == 0xbc);

#endif // FABLE_ENGINE_CCREATUREACTION_SHOWITEMTOTHING_H
