#ifndef FABLE_ENGINE_CCREATUREACTION_USELAMP_H
#define FABLE_ENGINE_CCREATUREACTION_USELAMP_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_UseLamp = 0xbc.
...
#pragma pack(push, 1)
struct CCreatureAction_UseLamp {
...
FABLE_STATIC_ASSERT(sizeof(CCreatureAction_UseLamp) == 0xbc);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UseLamp, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_UseLamp, PObjectToUse) == 0xb4);

#endif // FABLE_ENGINE_CCREATUREACTION_USELAMP_H
