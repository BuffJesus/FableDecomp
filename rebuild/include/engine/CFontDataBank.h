#ifndef FABLE_ENGINE_CFONTDATABANK_H
#define FABLE_ENGINE_CFONTDATABANK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CFontDataBank = 0x198.
...
struct CFontDataBank {
    ...
    unsigned char    StateBlock[0x10];                       // +0x174 CFontBankStateBlock
    unsigned char    Fonts[0x10];                            // +0x184 CArray<CFontDataBankEntry_*>
    CCharStringData* Filename_PStringData;                   // +0x194 CCharString::PStringData
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CFontDataBank) == 0x198);
FABLE_STATIC_ASSERT(offsetof(CFontDataBank, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CFontDataBank, StateBlock) == 0x174);
FABLE_STATIC_ASSERT(offsetof(CFontDataBank, Fonts) == 0x184);
FABLE_STATIC_ASSERT(offsetof(CFontDataBank, Filename_PStringData) == 0x194);

#endif // FABLE_ENGINE_CFONTDATABANK_H
