#ifndef FABLE_ENGINE_CAISTATEGROUP_JACKOFBLADESSTAGE2_H
#define FABLE_ENGINE_CAISTATEGROUP_JACKOFBLADESSTAGE2_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CAIStateGroup_JackOfBladesStage2 = 0x5c.
...
struct CAIStateGroup_JackOfBladesStage2 {
    ...
    unsigned char PCutsceneLookAtMarker[0x8];                // +0x54 CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CAIStateGroup_JackOfBladesStage2) == 0x5c);
FABLE_STATIC_ASSERT(offsetof(CAIStateGroup_JackOfBladesStage2, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CAIStateGroup_JackOfBladesStage2, PCutsceneLookAtMarker) == 0x54);

#endif // FABLE_ENGINE_CAISTATEGROUP_JACKOFBLADESSTAGE2_H
