#ifndef FABLE_ENGINE_CCREATUREACTION_BANDITKINGSTUCK_H
#define FABLE_ENGINE_CCREATUREACTION_BANDITKINGSTUCK_H
// GENERATED by tools/decomp_pipeline/gen_class_headers.py -- do not edit by hand.
// Donor: Ego_r.pdb (ghidra_out/struct_layouts_egor.tsv) sizeof CCreatureAction_BanditKingStuck = 0x140.
...
#pragma pack(push, 1)
struct CCreatureAction_BanditKingStuck {
    ...
    long          TimesToLoop;                               // +0x12c
    unsigned char PStuckEffect[0x8];                         // +0x130 CIntelligentPointer<CThing>
    unsigned char PObstruction[0x8];                         // +0x138 CIntelligentPointer<CThing>
};
#pragma pack(pop)

FABLE_STATIC_ASSERT(sizeof(CCreatureAction_BanditKingStuck) == 0x140);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingStuck, __vftable) == 0x0);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingStuck, TimesToLoop) == 0x12c);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingStuck, PStuckEffect) == 0x130);
FABLE_STATIC_ASSERT(offsetof(CCreatureAction_BanditKingStuck, PObstruction) == 0x138);

#endif // FABLE_ENGINE_CCREATUREACTION_BANDITKINGSTUCK_H
