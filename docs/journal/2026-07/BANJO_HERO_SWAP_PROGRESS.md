...
Start-outfit confirmed via `docs/engine/APPEARANCE_SYSTEM.md` + `appearance_survey.py`. **Verify:** 16/16
...
`docs/formats/MESH_COMPOSE.md` §1b + `docs/formats/BIG_MESH_GEOMETRY.md` §7/§7.1); this task USED that proven
...
meshes, docs/formats/MESH_COMPOSE.md §3/§5), but "MESH_HERO loads and animates as Banjo in Fable.exe"
