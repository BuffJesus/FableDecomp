...
the latest section of `docs/journal/HANDOFF_ARCHIVE.md`.
...
- `docs/journal/HANDOFF_ARCHIVE.md`: latest detailed checkpoint and resume state.
- `docs/ARCHITECTURE.md`: promotion and C++23 policy.
- `docs/pipeline/FULL_DECOMP.md`: full-decomp strategy.
- `docs/modding/README.md#comprehensive_modding_environment`: editor/tooling direction.
