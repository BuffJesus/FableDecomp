...
Shutdown handoff: `docs/journal/2026-08/SESSION_HANDOFF_2026-08-21_NO_DONOR.md` holds the
...
the previous — full detail in `docs/journal/FINDINGS_LOG.md`:
...
**Presentation layer** — see `docs/modding/README.md#forgetest64_ui_and_region` for the full
write-up: minimap working, transition screen staged but black, exit signpost
spawn failing silently, minimap zoom unresolved.

**Foliage** — RE done, writer not built. See `docs/engine/FOLIAGE_LOCAL_DETAIL_RE.md`.
...
4. `docs/journal/2026-08/PARTICLE_LIGHTING_VIEWER_HANDOFF.md` records the two sprite paths,
...
`docs/pipeline/UNICORN_EMULATION_PLAN.md`.
...
- [x] Analyzed the locally extracted original Xbox `default.xbe`, including the
  ...
  orphan five-clue text as PC; see `docs/scripts/STATUEMASTER_XBOX_XREF.md`.
...
- [x] Audited AlbionSecrets' 2025-11-05
  ...
  checker plus `docs/scripts/FSE_TUTORIAL_API_AUDIT.md`. Tooling validation and the
