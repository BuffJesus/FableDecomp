...
- Parity crawl: batch 161 is active in `work/crawl_batch155`; thirteen readable functions landed on 2026-09-08. Batch 161 still needs evidence review; do not accept propagated labels where the body contradicts the PDB layout or prototype. Details: `docs/journal/2026-09/PARITY_CRAWL_2026-09-08.md`.
