...
3. **Cutscene/region scripts = interpreted data** (`CCutsceneDef`/`CRegionScriptDef`
   ...
   docs/engine/SCRIPT_VM_MAP.md). Compiled quests *invoke* this layer; it does not host
...
- Related data-side markers in the exe: `START_ACTIVE_QUESTS`, `START_NEW_QUEST`,
  ...
  text-sectioned serialization family (see docs/formats/SAVE_ENTITY_GRAPH.md and the concurrent
