...
Oakvale prologue), the analog of `docs/engine/CONTINUE_GAME_PATH.md`. Two evidence tiers below:
...
- `CFrontEndManager::GotoNewProfileScreen @ 0x00595845` (176B) [DECODED head] — navigates
  ...
  creation screen — see docs/engine/NEW_PROFILE_SCREEN.md.**
...
(note: QFE-4035 codegen was proven == RTM 3077 — see docs/pipeline/QFE4035_COMPILER_GATE.md — so
...
are already landed — see docs/engine/NEW_PROFILE_SCREEN.md. Verify the [INFERRED] world-init chain
