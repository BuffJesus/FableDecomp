...
> **➤ Read `docs/engine/QUEST_CARD_DISPLAY_MAP.md` first** — the authoritative per-screen map (4-context
...
logbook / start screen), distinct from the small type-seal orb (docs/engine/QUEST_CARD_TEXTURE_BINDING.md)
and the text (docs/formats/QUEST_CARD_BYTE_LAYOUT.md).*
...
| **Type-seal orb** (by the title) | quest-type marker | `UI_QUEST_SPRITE_*` (5892/5894/5896) — docs/engine/QUEST_CARD_TEXTURE_BINDING.md |
