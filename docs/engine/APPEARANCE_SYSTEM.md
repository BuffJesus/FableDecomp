...
1. **Worn meshes** (1 per side, or a single mesh): skinned to the hero rig
   ...
   *Gap CLOSED (2026-07-20): `mesh_rw.compose_mesh(..., skeleton=
   ...
   of a NEW re-skinned boot injected as id 8115 (docs/formats/MESH_COMPOSE.md
...
## 7b. Hero SKIN (face/hands) — see docs/engine/HERO_MORPH.md (2026-07-20)
...
table and the corrected stage-2 green-tint staging: `docs/engine/HERO_MORPH.md`.
...
- Live (in-game) test of a composed skinned mesh: composition itself is now
  ...
  docs/formats/MESH_COMPOSE.md §1b), but a Fable.exe load of a composed type-5 entry
