...
known parent-vs-entity scope limits are documented in `docs/scripts/SEED_NATIVE_OPERATION_COMPARISON.md`.
...
`docs/modding/README.md#forgefse_retail_script_runtime`.
