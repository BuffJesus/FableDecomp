...
| **Controller / input** | ✅ enums recovered (empirical) | data-edit (`CControlsDef`) | **HIGH** — rebind UI feasible (DIK scancodes; 28-byte records) | CONTROLLER_ENUMS | Full PDB enum 0–114 and the 31-entry Redefine ActionOrder labels are now sourced; motor rumble is dead code (screen-quake only) |
