...
`docs/formats/BIG_MESH_GEOMETRY.md`) to "author custom assets": compose a complete
...
recipe (`docs/engine/APPEARANCE_SYSTEM.md` §7).*
...
## EgoCore corroboration + extensions (2026-07-31, see docs/journal/2026-07/EGOCORE_ASSESSMENT_20260731.md)
