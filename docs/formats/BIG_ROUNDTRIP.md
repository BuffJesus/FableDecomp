...
This is the mandatory writer gate flagged in `docs/formats/BIG_FAMILY_FORMATS.md` §6 and
`docs/formats/TEXTBIG_FORMAT.md` §7: prove a read → in-memory model → RE-SERIALIZE cycle reproduces an
...
Format reference: `docs/formats/TEXTBIG_FORMAT.md` (container) + `docs/formats/BIG_FAMILY_FORMATS.md` (family).
