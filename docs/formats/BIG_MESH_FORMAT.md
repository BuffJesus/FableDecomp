...
This doc EXTENDS `docs/formats/BIG_FAMILY_FORMATS.md` (§5 left MBANK "payload not decoded") and
`docs/formats/BIG_ROUNDTRIP.md` §7 (CRC = per-format-class fingerprint). It does not modify them.
