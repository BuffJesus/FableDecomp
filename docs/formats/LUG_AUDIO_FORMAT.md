...
Sibling doc: `docs/formats/LUT_AUDIOBANK_FORMAT.md` — the `.lut` **dialogue** banks. Same family
...
3. **`docs/formats/LUT_AUDIOBANK_FORMAT.md`** — the sibling bank format cracked yesterday; identical
...
for the `.lut` dialogue writer (`docs/formats/LUT_WRITER.md` §4 — its suggested
