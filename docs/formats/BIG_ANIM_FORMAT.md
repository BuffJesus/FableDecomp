...
This doc is the animation companion to `docs/formats/BIG_MESH_FORMAT.md` / `docs/formats/BIG_MESH_GEOMETRY.md`
...
- TOC **Type 9 = single-frame phoneme/viseme POSE anims** (frameCount=1, duration 0, AMSK
  ...
  form (subset TBD). End-to-end demon-door case study: `docs/engine/DEMON_DOOR_FACE.md`.
  - **Reconcile (EgoCore, 2026-07-31):** EgoCore's primary discriminator for Type 9 is the
    ...
    `docs/journal/2026-07/EGOCORE_ASSESSMENT_20260731.md`. The GLTF-anim retargeter (`GltfAnimImporter.h`) is the
