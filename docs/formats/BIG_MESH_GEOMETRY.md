...
> `CMemoryDataInputStream`). A later Ghidra xref pass (`docs/formats/MESH_BANK_INFLATE.md`) traced
...
question that `docs/formats/BIG_MESH_FORMAT.md` §6 left open as "Big Blue Box proprietary control-byte
...
inside the mesh bbox — see docs/modding/README.md#blender_addon).
