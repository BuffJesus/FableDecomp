...
**Companions:** `docs/formats/SAVEGAME_FORMAT.md` (container/zlib/CRC), `docs/formats/SAVE_HEADER_MAP.md`
(HEADER/PLAYER tags), `docs/formats/SAVE_HERO_STATS.md` (CTCHeroStats field map). Read those first.
