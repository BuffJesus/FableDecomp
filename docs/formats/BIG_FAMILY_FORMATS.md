...
*Authored 2026-07-19. Status: the BIGB reader from `docs/formats/TEXTBIG_FORMAT.md` is **VALIDATED across all 8
...
2. **`docs/formats/TEXTBIG_FORMAT.md`** — the text.big BIGB spec (itself triangulated against EgoCore's
