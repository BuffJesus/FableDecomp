...
allowed this run). Companions: `docs/formats/TEXT_BIG_WRITE.md` (text), `docs/formats/LUT_WRITER.md` +
`docs/formats/LUG_AUDIO_FORMAT.md` §8 (audio), `docs/formats/ANIM_WRITER.md` (lipsync),
`docs/engine/DEMON_DOOR_FACE.md` (how the mouth animates from the lipsync curve).*
