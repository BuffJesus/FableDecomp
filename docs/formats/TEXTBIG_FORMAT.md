...
(verified 26,807/26,807: `NONE`=0, empty=3, `FARMER`=4, …). See `docs/formats/TEXT_BIG_WRITE.md`.
...
- ~~Byte-exact **write** round-trip not yet proven for `.big`~~ **PROVEN 2026-07-20**:
  ...
  all other entries byte-identical. Recipe + evidence: `docs/formats/TEXT_BIG_WRITE.md`.
