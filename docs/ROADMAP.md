...
- [ ] Keep the parity crawl moving through batch 201 (165 readable MATCH/RELOCATION_MATCH landings on 2026-09-08; catalog 18,796 entries) — `docs/pipeline/FULL_DECOMP.md`
...
- `compiled` — builds to a VC7.1 object; no parity claimed (18,718)
