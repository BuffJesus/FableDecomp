...
- [ ] Keep the parity crawl moving through batch 169 (thirty readable MATCH/RELOCATION_MATCH landings on 2026-09-08; catalog 18,661 entries) — `docs/pipeline/FULL_DECOMP.md`
