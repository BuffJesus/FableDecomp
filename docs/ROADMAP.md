...
- [ ] Keep the parity crawl moving through batch 173 (forty-three readable MATCH/RELOCATION_MATCH landings on 2026-09-08; catalog 18,674 entries) — `docs/pipeline/FULL_DECOMP.md`
