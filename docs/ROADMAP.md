...
- [ ] Keep the parity crawl moving through batch 164 (twenty-six readable MATCH/RELOCATION_MATCH landings on 2026-09-08; catalog 18,657 entries) — `docs/pipeline/FULL_DECOMP.md`
