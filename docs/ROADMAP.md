...
- [ ] Keep the parity crawl moving through batch 178 (forty-eight readable MATCH/RELOCATION_MATCH landings on 2026-09-08; catalog 18,679 entries) — `docs/pipeline/FULL_DECOMP.md`
